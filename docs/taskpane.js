...
function resolveApiUrl() {
  var _process$env2, _window$location;
  var winOverride = typeof window !== "undefined" && typeof window.__VEJICE_API_URL === "string" ? window.__VEJICE_API_URL.trim() : "";
  if (winOverride) return winOverride;
  var envUrl = typeof process !== "undefined" && typeof ((_process$env2 = process.env) === null || _process$env2 === void 0 ? void 0 : "https://127.0.0.1:4001/api/postavi_vejice") === "string" ? "https://127.0.0.1:4001/api/postavi_vejice".trim() : "";
  if (envUrl) return envUrl;
  if (typeof window !== "undefined" && (_window$location = window.location) !== null && _window$location !== void 0 && _window$location.origin) {
    return "".concat(window.location.origin, "/api/postavi_vejice");
  }
  return "/api/postavi_vejice";
}
var API_URL = resolveApiUrl();
var API_KEY = typeof window !== "undefined" && window.__VEJICE_API_KEY || "";
var DEFAULT_API_MAX_ATTEMPTS = 2;
...
var DATE_DOT_PATTERN = /\b(\d{1,2})\.\s*(\d{1,2})(?:\.\s*(\d{2,4}))?\b/g;
var INITIALS_DOT_PATTERN = /\b(?:(?:[A-Za-z\xAA\xB5\xBA\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0560-\u0588\u05D0-\u05EA\u05EF-\u05F2\u0620-\u064A\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07CA-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u0870-\u0887\u0889-\u088F\u08A0-\u08C9\u0904-\u0939\u093D\u0950\u0958-\u0961\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09F0\u09F1\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B71\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C5C\u0C5D\u0C60\u0C61\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDC-\u0CDE\u0CE0\u0CE1\u0CF1\u0CF2\u0D04-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D5F-\u0D61\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E81\u0E82\u0E84\u0E86-\u0E8A\u0E8C-\u0EA3\u0EA5\u0EA7-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0EDC-\u0EDF\u0F00\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16F1-\u16F8\u1700-\u1711\u171F-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u1820-\u1878\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1950-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u1A00-\u1A16\u1A20-\u1A54\u1AA7\u1B05-\u1B33\u1B45-\u1B4C\u1B83-\u1BA0\u1BAE\u1BAF\u1BBA-\u1BE5\u1C00-\u1C23\u1C4D-\u1C4F\u1C5A-\u1C7D\u1C80-\u1C8A\u1C90-\u1CBA\u1CBD-\u1CBF\u1CE9-\u1CEC\u1CEE-\u1CF3\u1CF5\u1CF6\u1CFA\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2071\u207F\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2183\u2184\u2C00-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005\u3006\u3031-\u3035\u303B\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312F\u3131-\u318E\u31A0-\u31BF\u31F0-\u31FF\u3400-\u4DBF\u4E00-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA61F\uA62A\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6E5\uA717-\uA71F\uA722-\uA788\uA78B-\uA7DC\uA7F1-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA840-\uA873\uA882-\uA8B3\uA8F2-\uA8F7\uA8FB\uA8FD\uA8FE\uA90A-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF\uA9E0-\uA9E4\uA9E6-\uA9EF\uA9FA-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB69\uAB70-\uABE2\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDE80-\uDE9C\uDEA0-\uDED0\uDF00-\uDF1F\uDF2D-\uDF40\uDF42-\uDF49\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF]|\uD801[\uDC00-\uDC9D\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDD70-\uDD7A\uDD7C-\uDD8A\uDD8C-\uDD92\uDD94\uDD95\uDD97-\uDDA1\uDDA3-\uDDB1\uDDB3-\uDDB9\uDDBB\uDDBC\uDDC0-\uDDF3\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67\uDF80-\uDF85\uDF87-\uDFB0\uDFB2-\uDFBA]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC60-\uDC76\uDC80-\uDC9E\uDCE0-\uDCF2\uDCF4\uDCF5\uDD00-\uDD15\uDD20-\uDD39\uDD40-\uDD59\uDD80-\uDDB7\uDDBE\uDDBF\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE35\uDE60-\uDE7C\uDE80-\uDE9C\uDEC0-\uDEC7\uDEC9-\uDEE4\uDF00-\uDF35\uDF40-\uDF55\uDF60-\uDF72\uDF80-\uDF91]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2\uDD00-\uDD23\uDD4A-\uDD65\uDD6F-\uDD85\uDE80-\uDEA9\uDEB0\uDEB1\uDEC2-\uDEC7\uDF00-\uDF1C\uDF27\uDF30-\uDF45\uDF70-\uDF81\uDFB0-\uDFC4\uDFE0-\uDFF6]|\uD804[\uDC03-\uDC37\uDC71\uDC72\uDC75\uDC83-\uDCAF\uDCD0-\uDCE8\uDD03-\uDD26\uDD44\uDD47\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDDA\uDDDC\uDE00-\uDE11\uDE13-\uDE2B\uDE3F\uDE40\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61\uDF80-\uDF89\uDF8B\uDF8E\uDF90-\uDFB5\uDFB7\uDFD1\uDFD3]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC5F-\uDC61\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE80-\uDEAA\uDEB8\uDF00-\uDF1A\uDF40-\uDF46]|\uD806[\uDC00-\uDC2B\uDCA0-\uDCDF\uDCFF-\uDD06\uDD09\uDD0C-\uDD13\uDD15\uDD16\uDD18-\uDD2F\uDD3F\uDD41\uDDA0-\uDDA7\uDDAA-\uDDD0\uDDE1\uDDE3\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE89\uDE9D\uDEB0-\uDEF8\uDFC0-\uDFE0]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46\uDD60-\uDD65\uDD67\uDD68\uDD6A-\uDD89\uDD98\uDDB0-\uDDDB\uDEE0-\uDEF2\uDF02\uDF04-\uDF10\uDF12-\uDF33\uDFB0]|\uD808[\uDC00-\uDF99]|\uD809[\uDC80-\uDD43]|\uD80B[\uDF90-\uDFF0]|[\uD80C\uD80E\uD80F\uD81C-\uD822\uD840-\uD868\uD86A-\uD86D\uD86F-\uD872\uD874-\uD879\uD880-\uD883\uD885-\uD88C][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2F\uDC41-\uDC46\uDC60-\uDFFF]|\uD810[\uDC00-\uDFFA]|\uD811[\uDC00-\uDE46]|\uD818[\uDD00-\uDD1D]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE70-\uDEBE\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDD40-\uDD6C\uDE40-\uDE7F\uDEA0-\uDEB8\uDEBB-\uDED3\uDF00-\uDF4A\uDF50\uDF93-\uDF9F\uDFE0\uDFE1\uDFE3\uDFF2\uDFF3]|\uD823[\uDC00-\uDCD5\uDCFF-\uDD1E\uDD80-\uDDF2]|\uD82B[\uDFF0-\uDFF3\uDFF5-\uDFFB\uDFFD\uDFFE]|\uD82C[\uDC00-\uDD22\uDD32\uDD50-\uDD52\uDD55\uDD64-\uDD67\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB]|\uD837[\uDF00-\uDF1E\uDF25-\uDF2A]|\uD838[\uDC30-\uDC6D\uDD00-\uDD2C\uDD37-\uDD3D\uDD4E\uDE90-\uDEAD\uDEC0-\uDEEB]|\uD839[\uDCD0-\uDCEB\uDDD0-\uDDED\uDDF0\uDEC0-\uDEDE\uDEE0-\uDEE2\uDEE4\uDEE5\uDEE7-\uDEED\uDEF0-\uDEF4\uDEFE\uDEFF\uDFE0-\uDFE6\uDFE8-\uDFEB\uDFED\uDFEE\uDFF0-\uDFFE]|\uD83A[\uDC00-\uDCC4\uDD00-\uDD43\uDD4B]|\uD83B[\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD869[\uDC00-\uDEDF\uDF00-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEAD\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0\uDFF0-\uDFFF]|\uD87B[\uDC00-\uDE5D]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A\uDF50-\uDFFF]|\uD88D[\uDC00-\uDC79])\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*){2,}/g;
var DOT_GUARD_PATTERNS = [INITIALS_DOT_PATTERN, /\b\d{1,2}\.\s*\d{1,2}\.\s*\d{2,4}\b/g, /\b(?:npr|itd|itn|ipd|idr|oz|tj|dr|mr|ga|go[s\u017F]|prim|prof|doc|mag|jan|feb|mar|apr|jun|jul|avg|[s\u017F]ep|o[k\u212A]t|nov|dec)\./gi, /\b(?:d\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*o\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*o\.|d\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*d\.|[s\u017F]\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*p\.|d\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*n\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*o\.|[k\u212A]\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*d\.)/gi];
...
function resolveFeatureFlag(_ref) {
  var _ref$windowKeys = _ref.windowKeys,
    windowKeys = _ref$windowKeys === void 0 ? [] : _ref$windowKeys,
    envKey = _ref.envKey,
    defaultValue = _ref.defaultValue;
  if (typeof window !== "undefined") {
    var _iterator2 = _createForOfIteratorHelper(windowKeys),
      _step2;
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var key = _step2.value;
        if (!key) continue;
        var parsed = boolFromString(window[key]);
  ...
  if (typeof process !== "undefined" && envKey) {
    var _process$env4;
    var _parsed = boolFromString((_process$env4 = process.env) === null || _process$env4 === void 0 ? void 0 : _process$env4[envKey]);
    if (typeof _parsed === "boolean") return _parsed;
  }
  return defaultValue;
}
function resolveApiMaxAttempts() {
  var _window$__VEJICE_API_, _process$env$VEJICE_A, _process$env5, _process$env6, _ref2;
  var winValue = typeof window !== "undefined" ? numberFromUnknown((_window$__VEJICE_API_ = window.__VEJICE_API_MAX_ATTEMPTS) !== null && _window$__VEJICE_API_ !== void 0 ? _window$__VEJICE_API_ : window.__VEJICE_MAX_API_ATTEMPTS__) : undefined;
  var envValue = typeof process !== "undefined" ? numberFromUnknown((_process$env$VEJICE_A = (_process$env5 = process.env) === null || _process$env5 === void 0 ? void 0 : _process$env5.VEJICE_API_MAX_ATTEMPTS) !== null && _process$env$VEJICE_A !== void 0 ? _process$env$VEJICE_A : (_process$env6 = process.env) === null || _process$env6 === void 0 ? void 0 : _process$env6.VEJICE_MAX_API_ATTEMPTS) : undefined;
  var resolved = (_ref2 = winValue !== null && winValue !== void 0 ? winValue : envValue) !== null && _ref2 !== void 0 ? _ref2 : DEFAULT_API_MAX_ATTEMPTS;
  return Math.max(1, Math.min(5, Math.round(resolved)));
}
var API_MAX_ATTEMPTS = resolveApiMaxAttempts();
var ENABLE_NORMALIZED_TRANSPORT_RETRY = resolveFeatureFlag({
  windowKeys: ["__VEJICE_ENABLE_NORMALIZED_TRANSPORT_RETRY__", "__VEJICE_NORMALIZED_TRANSPORT_RETRY__"],
  envKey: "VEJICE_ENABLE_NORMALIZED_TRANSPORT_RETRY",
  defaultValue: false
});
var ENABLE_OG_COMPAT_RETRY = resolveFeatureFlag({
  windowKeys: ["__VEJICE_ENABLE_OG_COMPAT_RETRY__", "__VEJICE_OG_COMPAT_RETRY__"],
  envKey: "VEJICE_ENABLE_OG_COMPAT_RETRY",
  defaultValue: false
});
var TRANSPORT_SPACE_LIKE_CHARS = new Set(["\xA0", "\u1680", "\u2000", "\u2001", "\u2002", "\u2003", "\u2004", "\u2005", "\u2006", "\u2007", "\u2008", "\u2009", "\u200A", "\u202F", "\u205F", "\u3000"]);
var TRANSPORT_DASH_LIKE_CHARS = new Set(["\u2013", "\u2014", "\u2212"]);
var TRANSPORT_QUOTE_LIKE_CHARS = new Set(["\xAB", "\xBB"]);
var TRANSPORT_ZERO_WIDTH_OR_CONTROL = /[\0-\x08\x0B\f\x0E-\x1F\x7F-\x9F\u200B-\u200D\u2060\uFEFF]/;
var PRIVATE_USE_CHAR = /[\uE000-\uF8FF]/;
var PRIVATE_USE_CHAR_GLOBAL = /[\uE000-\uF8FF]/g;
var PRIVATE_USE_BETWEEN_DIGITS = /([0-9])[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*[\uE000-\uF8FF][\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*([0-9])/g;
...
function normalizeKnownProblematicChars() {
  var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  if (typeof text !== "string" || !text || !PRIVATE_USE_CHAR.test(text)) {
    return {
      text: typeof text === "string" ? text : "",
      replacedDateSeparators: 0,
      replacedPrivateUse: 0
    };
  }
  var replacedDateSeparators = 0;
  var withDateSeparators = text.replace(PRIVATE_USE_BETWEEN_DIGITS, function (_, left, right) {
    replacedDateSeparators++;
    return "".concat(left, ". ").concat(right);
  });
  var replacedPrivateUse = 0;
  var normalized = withDateSeparators.replace(PRIVATE_USE_CHAR_GLOBAL, function () {
    replacedPrivateUse++;
    return " ";
  });
  return {
    text: normalized,
    replacedDateSeparators: replacedDateSeparators,
    replacedPrivateUse: replacedPrivateUse
  };
}
function normalizeTransportText() {
  var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
...
function buildPrimaryRequestPayload() {
  var sentence = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  var problematic = normalizeKnownProblematicChars(sentence);
  var dotProtected = protectProblematicDots(problematic.text);
  return {
    ...
    sanitized: problematic.replacedDateSeparators > 0 || problematic.replacedPrivateUse > 0 || dotProtected !== sentence
  };
}
function hasTransportNormalizationOpportunity() {
  var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  var normalized = normalizeTransportText(text);
  return normalized.text !== text;
}
function restoreOriginalTypography() {
  var originalText = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  var normalizedSource = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  var correctedText = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
  if (typeof originalText !== "string" || typeof normalizedSource !== "string" || typeof correctedText !== "string" || !originalText) {
    return {
      text: correctedText,
      restoredChars: 0
    };
  }
  var correctedChars = Array.from(correctedText);
  var sourceChars = Array.from(normalizedSource);
  var originalChars = Array.from(originalText);
  ...
  return {
    text: correctedChars.join(""),
    restoredChars: restoredChars
  };
}
function protectProblematicDots() {
  ...
  var _iterator4 = _createForOfIteratorHelper(DOT_GUARD_PATTERNS),
    _step4;
  try {
...
function protectDateDots() {
  var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  if (typeof text !== "string" || !text) return text;
  return text.replace(DATE_DOT_PATTERN, function (match) {
    return match.replace(/\./g, DOT_GUARD_PLACEHOLDER);
  });
}
...
function buildOgCompatPayloads(sentence) {
  return [{
    ...
    mode: "minimal_space",
    data: {
      "vhodna poved": sentence
    }
  }, {
    mode: "minimal_no_parallel",
    data: {
      vhodna_poved: sentence,
      hkratne_napovedi: false
    }
  }];
}
...
function _requestPopravek() {
  _requestPopravek = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(poved) {
    var url, primaryPayload, primaryRequestSentence, data, config, attempts, protectedRetryUsed, ogCompatRetryUsed, normalizedRetryUsed, attempt, _performance$now, _performance, _performance$now2, t0, _primaryRequestSenten, _performance$now3, _performance2, _performance2$now, r, t1, normalizedResult, restoredTypography, correctedText, raw, _performance$now4, _performance3, _performance3$now, _t, durationMs, info, canTryProtectedDots, protectedSentence, _poved$length, protectedData, protectedResponse, _normalizeResponsePay, _correctedText, _raw, protectedInfo, canTryOgCompat, compatPayloads, _iterator5, _step5, compat, _poved$length2, compatResponse, _normalizeResponsePay2, _correctedText2, _raw2, compatInfo, canTryNormalizedTransport, normalized, _poved$length3, normalizedSentence, normalizedData, normalizedResponse, _normalizedResult, restored, _raw3, normalizedInfo, retryable, delay, _t2, _t3, _t4, _t5, _t6;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 3:
          url = API_URL;
          primaryPayload = buildPrimaryRequestPayload(poved);
          primaryRequestSentence = primaryPayload.requestSentence;
          data = buildRequestData(primaryRequestSentence);
          config = {
            headers: {
              "Content-Type": "application/json",
          ...
          ogCompatRetryUsed = false;
          normalizedRetryUsed = false;
          attempt = 1;
        case 4:
          if (!(attempt <= attempts)) {
            _context2.n = 31;
          ...
          log("POST", url, "| len:", (_primaryRequestSenten = primaryRequestSentence === null || primaryRequestSentence === void 0 ? void 0 : primaryRequestSentence.length) !== null && _primaryRequestSenten !== void 0 ? _primaryRequestSenten : 0, "| snippet:", snip(primaryRequestSentence), "| attempt:", attempt);
          _context2.n = 6;
        ...
        case 6:
          ...
          normalizedResult = normalizeResponsePayload(primaryPayload.transportSource, r === null || r === void 0 ? void 0 : r.data);
          restoredTypography = primaryPayload.transportReplacements > 0 ? restoreOriginalTypography(primaryPayload.canonicalSource, primaryPayload.transportSource, normalizedResult.correctedText) : {
            text: normalizedResult.correctedText,
            restoredChars: 0
          };
          correctedText = restoredTypography.text;
          raw = _objectSpread(_objectSpread({}, normalizedResult.raw), {}, {
            source_text: poved,
            target_text: correctedText
          });
        ...
        case 7:
          ...
          log("Retrying once with dot-protected payload", {
            attempt: attempt,
            len: (_poved$length = poved === null || poved === void 0 ? void 0 : poved.length) !== null && _poved$length !== void 0 ? _poved$length : 0,
            snippet: snip(poved)
          });
        ...
        case 9:
          ...
          _normalizeResponsePay = normalizeResponsePayload(poved, protectedResponse === null || protectedResponse === void 0 ? void 0 : protectedResponse.data), _correctedText = _normalizeResponsePay.correctedText, _raw = _normalizeResponsePay.raw;
        ...
        case 12:
          canTryOgCompat = ENABLE_OG_COMPAT_RETRY && !ogCompatRetryUsed && !USE_MOCK && typeof (info === null || info === void 0 ? void 0 : info.status) === "number" && info.status >= 500;
          if (!canTryOgCompat) {
            _context2.n = 22;
            break;
          }
          ogCompatRetryUsed = true;
          compatPayloads = buildOgCompatPayloads(poved);
          _iterator5 = _createForOfIteratorHelper(compatPayloads);
          _context2.p = 13;
          _iterator5.s();
        case 14:
          ...
          _context2.n = 16;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, compat.data, config);
        case 16:
          compatResponse = _context2.v;
          _normalizeResponsePay2 = normalizeResponsePayload(poved, compatResponse === null || compatResponse === void 0 ? void 0 : compatResponse.data), _correctedText2 = _normalizeResponsePay2.correctedText, _raw2 = _normalizeResponsePay2.raw;
          _raw2.og_compat = {
            used: true,
            mode: compat.mode
          };
          log("OK (OG-compatible)", {
            status: compatResponse === null || compatResponse === void 0 ? void 0 : compatResponse.status,
            mode: compat.mode,
            changed: _correctedText2 !== poved
          });
          return _context2.a(2, {
            correctedText: _correctedText2,
            raw: _raw2
          });
        case 17:
          _context2.p = 17;
          _t4 = _context2.v;
          compatInfo = describeAxiosError(_t4);
          log("ERROR (OG-compatible)", _objectSpread(_objectSpread({}, compatInfo), {}, {
            attempt: attempt,
            mode: compat.mode
          }));
        case 18:
        ...
        case 22:
          canTryNormalizedTransport = ENABLE_NORMALIZED_TRANSPORT_RETRY && !normalizedRetryUsed && !USE_MOCK && typeof (info === null || info === void 0 ? void 0 : info.status) === "number" && info.status >= 500 && hasTransportNormalizationOpportunity(poved);
          ...
          _context2.p = 23;
          normalized = normalizeTransportText(poved);
          if (!(normalized.text !== poved)) {
            _context2.n = 25;
            break;
          }
          normalizedSentence = protectDateDots(normalized.text);
          log("Retrying once with normalized transport payload", {
            attempt: attempt,
            len: (_poved$length3 = poved === null || poved === void 0 ? void 0 : poved.length) !== null && _poved$length3 !== void 0 ? _poved$length3 : 0,
            snippet: snip(poved),
            replacements: normalized.replacements.length
          });
          normalizedData = buildRequestData(normalizedSentence);
          _context2.n = 24;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, normalizedData, config);
        case 24:
          normalizedResponse = _context2.v;
          _normalizedResult = normalizeResponsePayload(normalized.text, normalizedResponse === null || normalizedResponse === void 0 ? void 0 : normalizedResponse.data);
          restored = restoreOriginalTypography(poved, normalized.text, _normalizedResult.correctedText);
          _raw3 = _objectSpread(_objectSpread({}, _normalizedResult.raw), {}, {
            source_text: poved,
          ...
          log("OK (normalized transport)", {
            status: normalizedResponse === null || normalizedResponse === void 0 ? void 0 : normalizedResponse.status,
            changed: restored.text !== poved,
            restoredChars: restored.restoredChars
          });
          return _context2.a(2, {
            correctedText: restored.text,
            raw: _raw3
          });
        case 25:
          _context2.n = 27;
        ...
        case 26:
          _context2.p = 26;
          _t6 = _context2.v;
          normalizedInfo = describeAxiosError(_t6);
          log("ERROR (normalized transport)", _objectSpread(_objectSpread({}, normalizedInfo), {}, {
            attempt: attempt
          }));
        case 27:
    ...
    }, _callee2, null, [[23, 26], [15, 17], [13, 20, 21, 22], [8, 11], [5, 7]]);
  }));
  return _requestPopravek.apply(this, arguments);
}
...
function normalizeLemmaToken(raw, index) {
  var _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _raw$token, _ref9, _ref0, _ref1, _ref10, _ref11, _raw$pos;
  ...
  var posRaw = (_ref9 = (_ref0 = (_ref1 = (_ref10 = (_ref11 = (_raw$pos = raw.pos) !== null && _raw$pos !== void 0 ? _raw$pos : raw.upos) !== null && _ref11 !== void 0 ? _ref11 : raw.xpos) !== null && _ref10 !== void 0 ? _ref10 : raw.tag) !== null && _ref1 !== void 0 ? _ref1 : raw.posTag) !== null && _ref0 !== void 0 ? _ref0 : raw.partOfSpeech) !== null && _ref9 !== void 0 ? _ref9 : raw.part_of_speech;
  var pos = typeof posRaw === "string" ? posRaw.trim().toUpperCase() : "";
  return {
    text: text,
  ...
  return _createClass(CommaSuggestionEngine, [{
    ...
    value: function () {
      var _analyzeParagraph = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(_ref2) {
        var _this = this;
        var paragraphIndex, originalText, normalizedOriginalText, paragraphDocOffset, _ref2$forceSentenceCh, forceSentenceChunks, _ref2$conservativeSen, conservativeSentenceFallback, paragraphText, forceSentenceByLength, useSentenceChunks, debugEnabled, debugDump, chunks, normalizedSource, processedMeta, chunkDetails, apiErrors, nonCommaChunkSkips, makeSnippet, logSkippedChunk, _processChunk, _iterator2, _step2, chunk, hasDetailedChunk, canFallbackToSentences, _anchorsEntry, correctedParagraph, sourceTokens, targetTokens, anchorsEntry, suggestions, debugOpFlow, _i, _chunkDetails, _entry$metaRef, _entry$metaRef$remapp, entry, detailRef, ops, correctionTracking, correctionsPresent, fallbackOps, usingFallbackOnly, allOps, opFlow, _iterator3, _step3, op, offset, baseOp, adjustedOp, suggestion, _t3, _t4, _t5, _t6;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              paragraphIndex = _ref2.paragraphIndex, originalText = _ref2.originalText, normalizedOriginalText = _ref2.normalizedOriginalText, paragraphDocOffset = _ref2.paragraphDocOffset, _ref2$forceSentenceCh = _ref2.forceSentenceChunks, forceSentenceChunks = _ref2$forceSentenceCh === void 0 ? false : _ref2$forceSentenceCh, _ref2$conservativeSen = _ref2.conservativeSentenceFallback, conservativeSentenceFallback = _ref2$conservativeSen === void 0 ? false : _ref2$conservativeSen;
                  ...
                  return _regenerator().w(function (_context) {
                    while (1) switch (_context.p = _context.n) {
                      ...
                      case 1:
                        ...
                        _context.p = 2;
                        _context.n = 3;
                        return _this.apiClient.popraviPovedDetailed(chunk.normalizedText || chunk.text);
                      case 3:
                        detail = _context.v;
                        _context.n = 13;
                        break;
            ...
            case 17:
              ...
              _iterator3 = _createForOfIteratorHelper(allOps);
              _context2.p = 18;
              _iterator3.s();
            case 19:
        ...
        }, _callee2, this, [[18, 24, 25, 26], [5, 9, 10, 11]]);
      }));
...
function computeSuggestionConfidence(_ref5) {
...
function buildSnippetsFromMetadata(metadata, originalText, correctedText) {
  ...
  if (originalText) {
    ...
    var _ref6, _metadata$targetCharS, _ref7, _metadata$targetCharE;
    var start = (_ref6 = (_metadata$targetCharS = metadata.targetCharStart) !== null && _metadata$targetCharS !== void 0 ? _metadata$targetCharS : metadata.charStart) !== null && _ref6 !== void 0 ? _ref6 : 0;
    var end = (_ref7 = (_metadata$targetCharE = metadata.targetCharEnd) !== null && _metadata$targetCharE !== void 0 ? _metadata$targetCharE : metadata.charEnd) !== null && _ref7 !== void 0 ? _ref7 : start;
...
function splitParagraphIntoChunks() {
  ...
  var _ref8 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
    _ref8$preferWholePara = _ref8.preferWholeParagraph,
    preferWholeParagraph = _ref8$preferWholePara === void 0 ? true : _ref8$preferWholePara,
    _ref8$conservativePac = _ref8.conservativePack,
    conservativePack = _ref8$conservativePac === void 0 ? false : _ref8$conservativePac;
  var safeText = typeof text === "string" ? text : "";
  if (!safeText) return [];
  ...
  var pushSentence = function pushSentence(contentEnd) {
    ...
    if (typeof contentEnd !== "number" || contentEnd <= start) {
      var _ref9;
      start = Math.max(start, (_ref9 = gapEnd !== null && gapEnd !== void 0 ? gapEnd : contentEnd) !== null && _ref9 !== void 0 ? _ref9 : start);
      return;
    }
    sentences.push({
      start: start,
...
function buildChunksFromLemmaTokens() {
  ...
  var pushSentence = function pushSentence(contentEnd) {
    ...
    if (typeof contentEnd !== "number" || contentEnd <= sentenceStart) {
      var _ref0;
      sentenceStart = Math.max(sentenceStart, (_ref0 = gapEnd !== null && gapEnd !== void 0 ? gapEnd : contentEnd) !== null && _ref0 !== void 0 ? _ref0 : sentenceStart);
      return;
    }
    sentences.push({
      start: sentenceStart,
...
function collectCommaOpsFromCorrections(detail, anchorsEntry, paragraphIndex, tracking) {
  ...
  if (tracking && (_tracking$intents = tracking.intents) !== null && _tracking$intents !== void 0 && _tracking$intents.length) {
    ...
    var _iterator6 = _createForOfIteratorHelper(tracking.intents),
      _step6;
    try {
      for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
        var _ref1, _ref10, _intent$baseText, _intent$analysis, _intent$analysis2, _intent$analysis3;
        var intent = _step6.value;
        var anchor = intent === null || intent === void 0 ? void 0 : intent.anchor;
        if (!anchor) continue;
        var baseText = (_ref1 = (_ref10 = (_intent$baseText = intent.baseText) !== null && _intent$baseText !== void 0 ? _intent$baseText : (_intent$analysis = intent.analysis) === null || _intent$analysis === void 0 ? void 0 : _intent$analysis.baseText) !== null && _ref10 !== void 0 ? _ref10 : anchor.tokenText) !== null && _ref1 !== void 0 ? _ref1 : "";
...
function buildInsertSuggestionMetadata(entry, _ref11) {
  var _entry$documentOffset2, _ref12, _ref13, _ref14, _ref15, _sourceAround$at, _highlightAnchor$char, _entry$originalText2, _entry$paragraphIndex2;
  var originalCharIndex = _ref11.originalCharIndex,
    targetCharIndex = _ref11.targetCharIndex;
  if (!entry) return null;
  ...
  var highlightAnchor = (_ref12 = (_ref13 = (_ref14 = (_ref15 = (_sourceAround$at = sourceAround.at) !== null && _sourceAround$at !== void 0 ? _sourceAround$at : sourceAround.before) !== null && _ref15 !== void 0 ? _ref15 : sourceAround.after) !== null && _ref14 !== void 0 ? _ref14 : targetAround.at) !== null && _ref13 !== void 0 ? _ref13 : targetAround.before) !== null && _ref12 !== void 0 ? _ref12 : targetAround.after;
...
/* harmony export */   cancelDocumentCheck: function() { return /* binding */ cancelDocumentCheck; },
...
/* harmony export */   isDocumentCheckInProgress: function() { return /* binding */ isDocumentCheckInProgress; },
...
var VEJICE_MARKER_INSERT_UNDERLINE = "Wavy";
var VEJICE_MARKER_DELETE_UNDERLINE = "Wavy";
var VEJICE_MARKER_INSERT_UNDERLINE_COLOR = "#E67E22";
var VEJICE_MARKER_DELETE_UNDERLINE_COLOR = "#D32F2F";
var VEJICE_MARKER_TAG_PREFIX = "vejice.marker.";
var VEJICE_MARKER_TITLE = "Vejice Marker";
var TRAILING_COMMA_REGEX = /[,\s]+$/;
...
var onlineMarkerBaselineByKey = new Map();
var PENDING_SUGGESTIONS_STORAGE_BASE_KEY = "vejice.pendingSuggestionsOnline.v1";
var PENDING_SUGGESTIONS_SESSION_KEY = "vejice.pendingSuggestionsSessionId.v1";
var MAX_PARAGRAPH_CHARS = 3000; //???
...
var MARKER_RENDER_FAILED_MESSAGE = "Napake so bile najdene, vendar jih v Word Online ni bilo mogoče označiti.";
var PARAGRAPH_TIMEOUT_MESSAGE = "Nekateri odstavki niso bili pregledani zaradi casovne omejitve.";
var ONLINE_HIGHLIGHT_FLUSH_PARAGRAPHS = 3;
var ONLINE_HIGHLIGHT_FLUSH_SUGGESTIONS = 12;
var ONLINE_ACCEPT_MIN_CONFIDENCE_LEVEL = "medium";
var DISABLE_CHAR_SPAN_RANGES_ON_WORD_ONLINE = true;
var longSentenceNotified = false;
var chunkApiFailureNotified = false;
var paragraphTimeoutNotified = false;
var pendingScanNotifications = [];
var BOOLEAN_TRUE = new Set(["1", "true", "yes", "on"]);
var BOOLEAN_FALSE = new Set(["0", "false", "no", "off"]);
var charSpanRangeResolutionDisabled = (0,_utils_host_js__WEBPACK_IMPORTED_MODULE_1__.isWordOnline)() && DISABLE_CHAR_SPAN_RANGES_ON_WORD_ONLINE;
var charSpanRangeDisableLogged = false;
...
function resolvePendingSuggestionsStorageScope() {
  var _Office2;
  var docUrl = typeof Office !== "undefined" && typeof ((_Office2 = Office) === null || _Office2 === void 0 || (_Office2 = _Office2.context) === null || _Office2 === void 0 || (_Office2 = _Office2.document) === null || _Office2 === void 0 ? void 0 : _Office2.url) === "string" ? Office.context.document.url.trim() : "";
  if (docUrl) {
    return "doc.".concat(hashForStorageKey(docUrl.toLowerCase()));
  }
  if (typeof window !== "undefined") {
    try {
      var storage = window.sessionStorage;
      if (storage) {
        var sessionId = storage.getItem(PENDING_SUGGESTIONS_SESSION_KEY);
        if (!sessionId) {
          sessionId = "".concat(Date.now().toString(36), ".").concat(Math.random().toString(36).slice(2, 8));
...
function getPendingSuggestionsStorageKey() {
  return "".concat(PENDING_SUGGESTIONS_STORAGE_BASE_KEY, ".").concat(resolvePendingSuggestionsStorageScope());
}
function getSuggestionConfidenceLevel(suggestion) {
  var _suggestion$meta;
  var level = suggestion === null || suggestion === void 0 || (_suggestion$meta = suggestion.meta) === null || _suggestion$meta === void 0 || (_suggestion$meta = _suggestion$meta.confidence) === null || _suggestion$meta === void 0 ? void 0 : _suggestion$meta.level;
...
function isSuggestionAutoApplyEligibleOnline(suggestion) {
  var level = getSuggestionConfidenceLevel(suggestion);
...
function toConfidenceLogEntry(suggestion) {
  var _suggestion$meta$conf, _suggestion$meta2, _suggestion$meta3;
  return {
    id: suggestion === null || suggestion === void 0 ? void 0 : suggestion.id,
    paragraphIndex: suggestion === null || suggestion === void 0 ? void 0 : suggestion.paragraphIndex,
    kind: suggestion === null || suggestion === void 0 ? void 0 : suggestion.kind,
    level: getSuggestionConfidenceLevel(suggestion),
    score: (_suggestion$meta$conf = suggestion === null || suggestion === void 0 || (_suggestion$meta2 = suggestion.meta) === null || _suggestion$meta2 === void 0 || (_suggestion$meta2 = _suggestion$meta2.confidence) === null || _suggestion$meta2 === void 0 ? void 0 : _suggestion$meta2.score) !== null && _suggestion$meta$conf !== void 0 ? _suggestion$meta$conf : null,
    reasons: Array.isArray(suggestion === null || suggestion === void 0 || (_suggestion$meta3 = suggestion.meta) === null || _suggestion$meta3 === void 0 || (_suggestion$meta3 = _suggestion$meta3.confidence) === null || _suggestion$meta3 === void 0 ? void 0 : _suggestion$meta3.reasons) ? suggestion.meta.confidence.reasons : []
  };
}
function buildReasonIdSummary(suggestions) {
  var maxIdsPerReason = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 20;
  var summary = {};
  var _iterator = _createForOfIteratorHelper(suggestions || []),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var _suggestion$meta4;
      var suggestion = _step.value;
      var reasons = Array.isArray(suggestion === null || suggestion === void 0 || (_suggestion$meta4 = suggestion.meta) === null || _suggestion$meta4 === void 0 || (_suggestion$meta4 = _suggestion$meta4.confidence) === null || _suggestion$meta4 === void 0 ? void 0 : _suggestion$meta4.reasons) ? suggestion.meta.confidence.reasons : ["no_confidence_reason"];
      var uniqueReasons = reasons.length ? _toConsumableArray(new Set(reasons)) : ["no_confidence_reason"];
      var _iterator2 = _createForOfIteratorHelper(uniqueReasons),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          if (summary[reason].ids.length < maxIdsPerReason && suggestion !== null && suggestion !== void 0 && suggestion.id) {
...
function persistPendingSuggestionsOnline() {
  ...
  try {
    var storage = window.localStorage;
    if (!storage) return;
    var storageKey = getPendingSuggestionsStorageKey();
...
function restorePendingSuggestionsOnline() {
  ...
  try {
    var storage = window.localStorage;
    if (!storage) return 0;
    var raw = storage.getItem(getPendingSuggestionsStorageKey());
    if (!raw) return 0;
    var parsed = JSON.parse(raw);
    if (!Array.isArray(parsed)) return 0;
    var _iterator3 = _createForOfIteratorHelper(parsed),
      _step3;
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
...
var documentCheckInProgress = false;
var ACTION_TYPE_IDLE = "idle";
var ACTION_TYPE_CHECK = "check";
var ACTION_TYPE_APPLY = "apply";
var ACTION_TYPE_REJECT = "reject";
var ONLINE_CHECK_TIMEOUT_MS_DEFAULT = 120000;
var ONLINE_PARAGRAPH_TIMEOUT_MS_DEFAULT = 20000;
var CHECK_ABORT_REASON_TIMEOUT = "check-timeout";
var CHECK_ABORT_REASON_CANCELLED = "check-cancelled";
var CHECK_ABORT_REASON_SUPERSEDED = "check-superseded";
var CHECK_ABORT_REASON_PARAGRAPH_TIMEOUT = "paragraph-timeout";
var CHECK_TIMEOUT_MESSAGE = "Pregled je bil prekinjen zaradi casovne omejitve. Poskusite znova.";
var CHECK_CANCELLED_MESSAGE = "Pregled je bil prekinjen.";
var actionSequence = 0;
var activeActionState = {
  type: ACTION_TYPE_IDLE,
  token: null,
  startedAt: 0
};
var CheckAbortError = /*#__PURE__*/function (_Error) {
  function CheckAbortError(message, reason) {
    var _this;
    _classCallCheck(this, CheckAbortError);
    _this = _callSuper(this, CheckAbortError, [message]);
    _this.name = "CheckAbortError";
    _this.reason = reason || CHECK_ABORT_REASON_CANCELLED;
    return _this;
  }
  _inherits(CheckAbortError, _Error);
  return _createClass(CheckAbortError);
}(/*#__PURE__*/_wrapNativeSuper(Error));
...
function resolveOnlineCheckTimeoutMs() {
  ...
  if (timeoutOverride == null && typeof process !== "undefined") {
    var _process$env6;
    timeoutOverride = parsePositiveInteger((_process$env6 = process.env) === null || _process$env6 === void 0 ? void 0 : _process$env6.VEJICE_ONLINE_CHECK_TIMEOUT_MS);
  }
  return timeoutOverride !== null && timeoutOverride !== void 0 ? timeoutOverride : ONLINE_CHECK_TIMEOUT_MS_DEFAULT;
}
function resolveOnlineParagraphTimeoutMs() {
  ...
  if (timeoutOverride == null && typeof process !== "undefined") {
    var _process$env7;
    timeoutOverride = parsePositiveInteger((_process$env7 = process.env) === null || _process$env7 === void 0 ? void 0 : _process$env7.VEJICE_ONLINE_PARAGRAPH_TIMEOUT_MS);
  }
  return timeoutOverride !== null && timeoutOverride !== void 0 ? timeoutOverride : ONLINE_PARAGRAPH_TIMEOUT_MS_DEFAULT;
}
function getActiveActionType() {
  var _activeActionState;
  return ((_activeActionState = activeActionState) === null || _activeActionState === void 0 ? void 0 : _activeActionState.type) || ACTION_TYPE_IDLE;
}
...
function finishAction(token) {
  var _activeActionState2;
  if (!token || ((_activeActionState2 = activeActionState) === null || _activeActionState2 === void 0 ? void 0 : _activeActionState2.token) !== token) return;
  activeActionState = {
    type: ACTION_TYPE_IDLE,
    token: null,
    startedAt: 0
...
function cancelActionToken(token) {
  var reason = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : CHECK_ABORT_REASON_CANCELLED;
  if (!token) return;
  token.cancelled = true;
  token.cancelReason = reason;
}
function ensureCheckActionActive(token) {
  var _activeActionState3;
  if (!token) {
    throw new CheckAbortError("Missing check token", CHECK_ABORT_REASON_CANCELLED);
  }
  if (((_activeActionState3 = activeActionState) === null || _activeActionState3 === void 0 ? void 0 : _activeActionState3.token) !== token || getActiveActionType() !== ACTION_TYPE_CHECK) {
...
function runWithTimeout(_x, _x2, _x3, _x4) {
  return _runWithTimeout.apply(this, arguments);
}
function _runWithTimeout() {
  _runWithTimeout = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(promiseFactory, timeoutMs, timeoutReason, timeoutMessage) {
    var timeoutId;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
...
function waitForOnlineScanCompletion() {
  return _waitForOnlineScanCompletion.apply(this, arguments);
}
function _waitForOnlineScanCompletion() {
  _waitForOnlineScanCompletion = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
    var _ref39,
      _ref39$timeoutMs,
      timeoutMs,
      _ref39$pollMs,
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _ref39 = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {}, _ref39$timeoutMs = _ref39.timeoutMs, timeoutMs = _ref39$timeoutMs === void 0 ? 120000 : _ref39$timeoutMs, _ref39$pollMs = _ref39.pollMs, pollMs = _ref39$pollMs === void 0 ? 80 : _ref39$pollMs;
        ...
        case 2:
          if (!(getActiveActionType() === ACTION_TYPE_CHECK && Date.now() - startedAt < timeoutMs)) {
            _context2.n = 4;
            break;
          }
          _context2.n = 3;
...
function isDocumentCheckInProgress() {
  return Boolean(documentCheckInProgress || getActiveActionType() === ACTION_TYPE_CHECK);
}
function cancelDocumentCheck() {
  var _activeActionState4;
  var reason = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : CHECK_ABORT_REASON_CANCELLED;
  if (getActiveActionType() !== ACTION_TYPE_CHECK) return false;
  cancelActionToken((_activeActionState4 = activeActionState) === null || _activeActionState4 === void 0 ? void 0 : _activeActionState4.token, reason);
  return true;
}
...
function flushScanNotifications() {
  ...
  var seen = new Set();
  var uniqueMessages = [];
  var _iterator4 = _createForOfIteratorHelper(pendingScanNotifications),
    _step4;
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
...
function notifyParagraphTimeout(paragraphIndex, timeoutMs) {
  warn("Paragraph skipped due to timeout", {
    paragraphIndex: paragraphIndex,
    timeoutMs: timeoutMs
  });
...
function documentHasTrackedChanges(_x5) {
  return _documentHasTrackedChanges.apply(this, arguments);
}
function _documentHasTrackedChanges() {
  _documentHasTrackedChanges = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(context) {
    var revisions, _t;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
        ...
        case 4:
          ...
          return _context3.a(2, revisions.items.length > 0);
        case 5:
          _context3.p = 5;
          _t = _context3.v;
...
function getRangeForCharacterSpan(_x6, _x7, _x8, _x9, _x0) {
  return _getRangeForCharacterSpan.apply(this, arguments);
}
function _getRangeForCharacterSpan() {
  _getRangeForCharacterSpan = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(context, paragraph, paragraphText, charStart, charEnd) {
    var reason,
      fallbackSnippet,
      text,
      safeStart,
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          reason = _args4.length > 5 && _args4[5] !== undefined ? _args4[5] : "span";
          fallbackSnippet = _args4.length > 6 ? _args4[6] : undefined;
        ...
        case 10:
          ...
          return _context4.a(2, matches.items[idx]);
        case 11:
          _context4.p = 11;
          _t2 = _context4.v;
          if ((0,_utils_host_js__WEBPACK_IMPORTED_MODULE_1__.isWordOnline)() && String((_t2 === null || _t2 === void 0 ? void 0 : _t2.code) || (_t2 === null || _t2 === void 0 ? void 0 : _t2.message) || "").includes("InvalidRequest")) {
...
function getRangeForAnchorSpan(_x1, _x10, _x11, _x12, _x13) {
  return _getRangeForAnchorSpan.apply(this, arguments);
}
function _getRangeForAnchorSpan() {
  _getRangeForAnchorSpan = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(context, paragraph, anchorsEntry, charStart, charEnd) {
    var reason,
      fallbackSnippet,
      candidates,
      liveText,
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.n) {
        case 0:
          reason = _args5.length > 5 && _args5[5] !== undefined ? _args5[5] : "span";
          fallbackSnippet = _args5.length > 6 ? _args5[6] : undefined;
          candidates = [];
...
function searchParagraphForSnippet(_x14, _x15, _x16) {
  return _searchParagraphForSnippet.apply(this, arguments);
}
function _searchParagraphForSnippet() {
  _searchParagraphForSnippet = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(context, paragraph, snippet) {
    var range, matches;
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.n) {
        case 0:
          ...
          return context.sync();
        case 1:
          return _context6.a(2, matches);
      }
    }, _callee6);
  }));
  return _searchParagraphForSnippet.apply(this, arguments);
}
function getRangesForPlannedOperations(_x17, _x18, _x19, _x20) {
  return _getRangesForPlannedOperations.apply(this, arguments);
}
function _getRangesForPlannedOperations() {
  _getRangesForPlannedOperations = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(context, paragraph, snapshotText, plan) {
    var reason,
      text,
      liveText,
      searchOptions,
    ...
    return _regenerator().w(function (_context7) {
      while (1) switch (_context7.n) {
        case 0:
          reason = _args7.length > 4 && _args7[4] !== undefined ? _args7[4] : "apply-planned";
        ...
        case 1:
          ...
          return _context7.a(2, plan.map(function () {
            return null;
          }));
        case 2:
          if (!(typeof paragraph.text !== "string")) {
        ...
        case 3:
          ...
          return context.sync();
        case 4:
          return _context7.a(2, plan.map(function (op, opIndex) {
            var variants = perOpVariants[opIndex] || [];
            if (!variants.length) return null;
            var _iterator8 = _createForOfIteratorHelper(variants),
              _step8;
            try {
...
function buildDeleteRangeCandidates(suggestion) {
  var _suggestion$meta5;
  var ranges = [];
  var meta = suggestion === null || suggestion === void 0 || (_suggestion$meta5 = suggestion.meta) === null || _suggestion$meta5 === void 0 ? void 0 : _suggestion$meta5.anchor;
...
function insertCommaAt(_x21, _x22, _x23, _x24, _x25) {
...
function _insertCommaAt() {
  _insertCommaAt = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(context, paragraph, original, corrected, atCorrectedPos) {
...
function ensureSpaceAfterComma(_x26, _x27, _x28, _x29) {
  return _ensureSpaceAfterComma.apply(this, arguments);
} // Briši samo znak vejice
function _ensureSpaceAfterComma() {
  _ensureSpaceAfterComma = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(context, paragraph, corrected, atCorrectedPos) {
...
function deleteCommaAt(_x30, _x31, _x32, _x33) {
  return _deleteCommaAt.apply(this, arguments);
}
function _deleteCommaAt() {
  _deleteCommaAt = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0(context, paragraph, original, atOriginalPos) {
...
function highlightSuggestionOnline(_x34, _x35, _x36) {
  return _highlightSuggestionOnline.apply(this, arguments);
}
function _highlightSuggestionOnline() {
  _highlightSuggestionOnline = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1(context, paragraph, suggestion) {
    var _t3;
    return _regenerator().w(function (_context1) {
      while (1) switch (_context1.p = _context1.n) {
        ...
        case 1:
          ...
          return _context1.a(2, highlightDeleteSuggestion(context, paragraph, suggestion));
        case 2:
          return _context1.a(2, highlightInsertSuggestion(context, paragraph, suggestion));
        case 3:
          _context1.p = 3;
          _t3 = _context1.v;
          warn("highlightSuggestionOnline failed; skipping marker", _t3);
          return _context1.a(2, false);
      }
    }, _callee1, null, [[0, 3]]);
  }));
...
function normalizeHighlightColorForCompare(color) {
  var normalized = normalizeHighlightColorValue(color);
  return normalized ? normalized.toLowerCase() : null;
}
function normalizeHighlightColorToken(color) {
  var normalized = normalizeHighlightColorForCompare(color);
...
function normalizeUnderlineStyleForCompare(value) {
  var normalized = normalizeUnderlineStyleValue(value);
  return normalized ? normalized.toLowerCase() : null;
}
function isVejiceMarkerHighlightColor(color) {
  var token = normalizeHighlightColorToken(color);
  if (!token) return false;
  var insertToken = normalizeHighlightColorToken(HIGHLIGHT_INSERT);
  var deleteToken = normalizeHighlightColorToken(HIGHLIGHT_DELETE);
  var insertSet = new Set([insertToken, "#fff9c4", "#ffff00", "#ff0", "yellow"]);
  var deleteSet = new Set([deleteToken, "#ffcdd2", "#ff0000", "#f00", "red", "pink"]);
  return insertSet.has(token) || deleteSet.has(token);
}
function isVejiceMarkerStyle(underline, underlineColor) {
  var style = normalizeUnderlineStyleForCompare(underline);
  var color = normalizeHighlightColorForCompare(underlineColor);
  if (!style) return false;
  var insertStyle = normalizeUnderlineStyleForCompare(VEJICE_MARKER_INSERT_UNDERLINE);
  var deleteStyle = normalizeUnderlineStyleForCompare(VEJICE_MARKER_DELETE_UNDERLINE);
  var insertColor = normalizeHighlightColorForCompare(VEJICE_MARKER_INSERT_UNDERLINE_COLOR);
  var deleteColor = normalizeHighlightColorForCompare(VEJICE_MARKER_DELETE_UNDERLINE_COLOR);
  if (!color) {
    return style === insertStyle || style === deleteStyle;
  }
  return style === insertStyle && color === insertColor || style === deleteStyle && color === deleteColor;
}
...
function getSuggestionMarkerHighlightColor(suggestion) {
  return (suggestion === null || suggestion === void 0 ? void 0 : suggestion.kind) === "delete" ? HIGHLIGHT_DELETE : HIGHLIGHT_INSERT;
}
function sanitizeMarkerIdPart(value) {
  if (value === null || typeof value === "undefined") return "";
  var normalized = String(value).trim().toLowerCase().replace(/[^a-z0-9_-]+/g, "-").replace(/^-+|-+$/g, "");
  return normalized;
}
function buildSuggestionMarkerId(suggestion) {
  var _ref6, _ref7, _suggestion$meta$op$o, _suggestion$meta7, _suggestion$meta8, _suggestion$charHint;
  var paragraphIndex = Number.isFinite(suggestion === null || suggestion === void 0 ? void 0 : suggestion.paragraphIndex) ? suggestion.paragraphIndex : "p";
  var kind = sanitizeMarkerIdPart((suggestion === null || suggestion === void 0 ? void 0 : suggestion.kind) || "op");
  var opPos = (_ref6 = (_ref7 = (_suggestion$meta$op$o = suggestion === null || suggestion === void 0 || (_suggestion$meta7 = suggestion.meta) === null || _suggestion$meta7 === void 0 || (_suggestion$meta7 = _suggestion$meta7.op) === null || _suggestion$meta7 === void 0 ? void 0 : _suggestion$meta7.originalPos) !== null && _suggestion$meta$op$o !== void 0 ? _suggestion$meta$op$o : suggestion === null || suggestion === void 0 || (_suggestion$meta8 = suggestion.meta) === null || _suggestion$meta8 === void 0 || (_suggestion$meta8 = _suggestion$meta8.op) === null || _suggestion$meta8 === void 0 ? void 0 : _suggestion$meta8.pos) !== null && _ref7 !== void 0 ? _ref7 : suggestion === null || suggestion === void 0 || (_suggestion$charHint = suggestion.charHint) === null || _suggestion$charHint === void 0 ? void 0 : _suggestion$charHint.start) !== null && _ref6 !== void 0 ? _ref6 : "x";
  var baseId = sanitizeMarkerIdPart(suggestion === null || suggestion === void 0 ? void 0 : suggestion.id);
  var raw = [baseId, "p".concat(paragraphIndex), kind, "at".concat(opPos)].filter(Boolean).join("-");
  if (raw) return raw.slice(0, 120);
  return "m-".concat(Date.now().toString(36), "-").concat(Math.random().toString(36).slice(2, 8));
}
function getSuggestionMarkerTag(suggestion) {
  var _ref8 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
    _ref8$create = _ref8.create,
    create = _ref8$create === void 0 ? false : _ref8$create;
  if (!suggestion || _typeof(suggestion) !== "object") return null;
  var existingTag = typeof suggestion.markerTag === "string" ? suggestion.markerTag.trim() : "";
  ...
  var existingId = sanitizeMarkerIdPart(suggestion.markerId);
  if (existingId) {
    var _tag = "".concat(VEJICE_MARKER_TAG_PREFIX).concat(existingId);
    suggestion.markerId = existingId;
    suggestion.markerTag = _tag;
    return _tag;
  }
  if (!create) return null;
  var generated = buildSuggestionMarkerId(suggestion);
  var tag = "".concat(VEJICE_MARKER_TAG_PREFIX).concat(generated);
  suggestion.markerId = generated;
  suggestion.markerTag = tag;
  return tag;
}
function resetSuggestionMarkerState(suggestion) {
  var _ref9 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
    _ref9$releaseBaseline = _ref9.releaseBaseline,
    releaseBaseline = _ref9$releaseBaseline === void 0 ? true : _ref9$releaseBaseline;
  if (!suggestion || _typeof(suggestion) !== "object") return;
...
function buildSuggestionHighlightKey(suggestion) {
  var _suggestion$meta9, _ref0, _ref1, _ref10, _suggestion$charHint$, _suggestion$charHint2, _ref11, _ref12, _ref13, _suggestion$charHint$2, _suggestion$charHint3;
  var paragraphIndex = suggestion === null || suggestion === void 0 ? void 0 : suggestion.paragraphIndex;
  var anchor = (suggestion === null || suggestion === void 0 || (_suggestion$meta9 = suggestion.meta) === null || _suggestion$meta9 === void 0 ? void 0 : _suggestion$meta9.anchor) || {};
  var startRaw = (_ref0 = (_ref1 = (_ref10 = (_suggestion$charHint$ = suggestion === null || suggestion === void 0 || (_suggestion$charHint2 = suggestion.charHint) === null || _suggestion$charHint2 === void 0 ? void 0 : _suggestion$charHint2.start) !== null && _suggestion$charHint$ !== void 0 ? _suggestion$charHint$ : anchor.highlightCharStart) !== null && _ref10 !== void 0 ? _ref10 : anchor.charStart) !== null && _ref1 !== void 0 ? _ref1 : anchor.targetCharStart) !== null && _ref0 !== void 0 ? _ref0 : -1;
  var endRaw = (_ref11 = (_ref12 = (_ref13 = (_suggestion$charHint$2 = suggestion === null || suggestion === void 0 || (_suggestion$charHint3 = suggestion.charHint) === null || _suggestion$charHint3 === void 0 ? void 0 : _suggestion$charHint3.end) !== null && _suggestion$charHint$2 !== void 0 ? _suggestion$charHint$2 : anchor.highlightCharEnd) !== null && _ref13 !== void 0 ? _ref13 : anchor.charEnd) !== null && _ref12 !== void 0 ? _ref12 : anchor.targetCharEnd) !== null && _ref11 !== void 0 ? _ref11 : startRaw + 1;
  ...
  return "".concat(paragraphIndex, ":").concat(start, ":").concat(end);
}
function captureMarkerBaselineForSuggestion(suggestion, currentUnderline, currentUnderlineColor) {
  var key = (suggestion === null || suggestion === void 0 ? void 0 : suggestion.underlineBaselineKey) || (suggestion === null || suggestion === void 0 ? void 0 : suggestion.highlightBaselineKey) || buildSuggestionHighlightKey(suggestion);
  suggestion.underlineBaselineKey = key;
  suggestion.highlightBaselineKey = key;
  if (!key) {
    var fallbackUnderline = normalizeUnderlineStyleValue(currentUnderline);
    var fallbackUnderlineColor = normalizeHighlightColorValue(currentUnderlineColor);
  ...
  var existing = onlineMarkerBaselineByKey.get(key);
  if (existing) {
    existing.refCount += 1;
  ...
  var capturedUnderline = normalizeUnderlineStyleValue(currentUnderline);
  var capturedUnderlineColor = normalizeHighlightColorValue(currentUnderlineColor);
  var baselineUnderline = isVejiceMarkerStyle(capturedUnderline, capturedUnderlineColor) ? null : capturedUnderline;
  var baselineUnderlineColor = isVejiceMarkerStyle(capturedUnderline, capturedUnderlineColor) ? null : capturedUnderlineColor;
...
function releaseMarkerBaselineForSuggestion(suggestion) {
  var key = (suggestion === null || suggestion === void 0 ? void 0 : suggestion.underlineBaselineKey) || (suggestion === null || suggestion === void 0 ? void 0 : suggestion.highlightBaselineKey);
  if (!key) return;
  var existing = onlineMarkerBaselineByKey.get(key);
  if (existing) {
    existing.refCount -= 1;
...
function getSuggestionRestoreMarkerFormat(suggestion) {
  var _suggestion$previousU;
  var key = (suggestion === null || suggestion === void 0 ? void 0 : suggestion.underlineBaselineKey) || (suggestion === null || suggestion === void 0 ? void 0 : suggestion.highlightBaselineKey);
  if (key && onlineMarkerBaselineByKey.has(key)) {
    var cached = onlineMarkerBaselineByKey.get(key);
    var underline = normalizeUnderlineStyleValue(cached === null || cached === void 0 ? void 0 : cached.underline);
    var underlineColor = normalizeHighlightColorValue(cached === null || cached === void 0 ? void 0 : cached.underlineColor);
  ...
  var fallbackUnderline = normalizeUnderlineStyleValue(suggestion === null || suggestion === void 0 ? void 0 : suggestion.previousUnderline);
  var fallbackUnderlineColor = normalizeHighlightColorValue((_suggestion$previousU = suggestion === null || suggestion === void 0 ? void 0 : suggestion.previousUnderlineColor) !== null && _suggestion$previousU !== void 0 ? _suggestion$previousU : suggestion === null || suggestion === void 0 ? void 0 : suggestion.previousHighlightColor);
  if (isVejiceMarkerStyle(fallbackUnderline, fallbackUnderlineColor)) {
    return {
      underline: null,
      underlineColor: null
  ...
  return {
    underline: fallbackUnderline,
    underlineColor: fallbackUnderlineColor
  };
}
...
function applySuggestionMarkerFormat(_x37, _x38, _x39) {
  return _applySuggestionMarkerFormat.apply(this, arguments);
}
function _applySuggestionMarkerFormat() {
  _applySuggestionMarkerFormat = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10(context, range, suggestion) {
    var markerHighlightColor, markerTag, markerRange, markerControl, markerViaContentControl, existingHighlightColor, marker, _t4, _t5, _t6, _t7;
    return _regenerator().w(function (_context10) {
      while (1) switch (_context10.p = _context10.n) {
        case 0:
          ...
          markerHighlightColor = getSuggestionMarkerHighlightColor(suggestion);
          markerTag = getSuggestionMarkerTag(suggestion, {
            create: true
          });
          markerRange = range;
          markerControl = null;
          markerViaContentControl = false;
          _context10.p = 1;
          markerRange.font.load("highlightColor");
          _context10.n = 2;
          return context.sync();
        case 2:
          existingHighlightColor = normalizeHighlightColorValue(markerRange.font.highlightColor); // Preserve the user's exact original highlight (including yellow).
        ...
        case 3:
          _context10.p = 3;
          _t4 = _context10.v;
          warn("marker: failed to capture previous highlight color", _t4);
          suggestion.previousHighlightColor = null;
        case 4:
          if (markerTag) {
            try {
        ...
        case 7:
          _context10.p = 7;
          _t5 = _context10.v;
          warn("marker: failed to apply marker format", _t5);
          try {
            if (markerControl) {
        ...
        case 8:
          marker = getSuggestionMarkerFormat(suggestion);
          _context10.p = 9;
        ...
        case 11:
          _context10.p = 11;
          _t6 = _context10.v;
          warn("marker: failed to capture previous underline style", _t6);
          suggestion.previousUnderline = null;
          suggestion.previousUnderlineColor = null;
          suggestion.previousHighlightColor = null;
          suggestion.underlineBaselineKey = suggestion.underlineBaselineKey || suggestion.highlightBaselineKey || buildSuggestionHighlightKey(suggestion);
        ...
        case 14:
          _context10.p = 14;
          _t7 = _context10.v;
          warn("marker: failed to apply marker format", _t7);
          try {
            if (suggestion.highlightRange) {
              context.trackedObjects.remove(suggestion.highlightRange);
            }
    ...
    }, _callee10, null, [[12, 14], [9, 11], [5, 7], [1, 3]]);
  }));
  return _applySuggestionMarkerFormat.apply(this, arguments);
}
...
function highlightDeleteSuggestion(_x40, _x41, _x42) {
  return _highlightDeleteSuggestion.apply(this, arguments);
}
function _highlightDeleteSuggestion() {
  _highlightDeleteSuggestion = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11(context, paragraph, suggestion) {
    var _ref40, _suggestion$meta$orig, _suggestion$meta17, _suggestion$meta18, _ref41, _ref42, _suggestion$charHint$6, _suggestion$charHint8, _suggestion$meta19, _ref43, _suggestion$charHint$7, _suggestion$charHint9, _ref44, _meta$highlightText, _suggestion$meta20, paragraphText, meta, entry, charStart, charEnd, highlightText, targetRange, _suggestion$meta21, applied, _t8;
    return _regenerator().w(function (_context11) {
      while (1) switch (_context11.p = _context11.n) {
        case 0:
          _context11.p = 0;
          paragraphText = (_ref40 = (_suggestion$meta$orig = (_suggestion$meta17 = suggestion.meta) === null || _suggestion$meta17 === void 0 ? void 0 : _suggestion$meta17.originalText) !== null && _suggestion$meta$orig !== void 0 ? _suggestion$meta$orig : paragraph.text) !== null && _ref40 !== void 0 ? _ref40 : "";
          meta = ((_suggestion$meta18 = suggestion.meta) === null || _suggestion$meta18 === void 0 ? void 0 : _suggestion$meta18.anchor) || {};
          entry = anchorProvider.getAnchorsForParagraph(suggestion.paragraphIndex);
          charStart = (_ref41 = (_ref42 = (_suggestion$charHint$6 = (_suggestion$charHint8 = suggestion.charHint) === null || _suggestion$charHint8 === void 0 ? void 0 : _suggestion$charHint8.start) !== null && _suggestion$charHint$6 !== void 0 ? _suggestion$charHint$6 : meta.charStart) !== null && _ref42 !== void 0 ? _ref42 : (_suggestion$meta19 = suggestion.meta) === null || _suggestion$meta19 === void 0 || (_suggestion$meta19 = _suggestion$meta19.op) === null || _suggestion$meta19 === void 0 ? void 0 : _suggestion$meta19.originalPos) !== null && _ref41 !== void 0 ? _ref41 : -1;
          charEnd = (_ref43 = (_suggestion$charHint$7 = (_suggestion$charHint9 = suggestion.charHint) === null || _suggestion$charHint9 === void 0 ? void 0 : _suggestion$charHint9.end) !== null && _suggestion$charHint$7 !== void 0 ? _suggestion$charHint$7 : meta.charEnd) !== null && _ref43 !== void 0 ? _ref43 : typeof charStart === "number" && charStart >= 0 ? charStart + 1 : charStart;
          highlightText = (_ref44 = (_meta$highlightText = meta.highlightText) !== null && _meta$highlightText !== void 0 ? _meta$highlightText : (_suggestion$meta20 = suggestion.meta) === null || _suggestion$meta20 === void 0 ? void 0 : _suggestion$meta20.highlightText) !== null && _ref44 !== void 0 ? _ref44 : ",";
          targetRange = null;
          if (!(Number.isFinite(charStart) && charStart >= 0)) {
            _context11.n = 2;
            break;
        ...
        case 2:
          ...
          _context11.n = 3;
          return findCommaRangeByOrdinal(context, paragraph, paragraphText, (_suggestion$meta21 = suggestion.meta) === null || _suggestion$meta21 === void 0 ? void 0 : _suggestion$meta21.op);
        case 3:
          targetRange = _context11.v;
          if (targetRange) {
            _context11.n = 4;
        ...
        case 4:
          _context11.n = 5;
          return applySuggestionMarkerFormat(context, targetRange, suggestion);
        case 5:
          applied = _context11.v;
          if (applied) {
            _context11.n = 6;
            break;
          }
        ...
        case 7:
          _context11.p = 7;
          _t8 = _context11.v;
          warn("highlightDeleteSuggestion failed; skipping marker", _t8);
          return _context11.a(2, false);
      }
    }, _callee11, null, [[0, 7]]);
  }));
...
function highlightInsertSuggestion(_x43, _x44, _x45) {
  return _highlightInsertSuggestion.apply(this, arguments);
}
function _highlightInsertSuggestion() {
  _highlightInsertSuggestion = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12(context, paragraph, suggestion) {
    var _ref45, _suggestion$meta$corr, _suggestion$meta22, _suggestion$meta23, _suggestion$snippets$, _suggestion$snippets, _suggestion$meta$op$p, _suggestion$meta24, _suggestion$snippets$2, _suggestion$snippets2, _suggestion$meta$op$p2, _suggestion$meta25, corrected, anchor, entry, rawLeft, rawRight, lastWord, leftContext, searchOpts, range, resolveAnchorEnd, highlightAnchorCandidate, anchorEnd, _anchor$highlightAnch, _anchor$sourceTokenAt, _anchor$targetTokenAt, metaEndCandidate, metaEnd, wordSearch, leftSearch, rightSnippet, rightSearch, applied, _t9;
    return _regenerator().w(function (_context12) {
      while (1) switch (_context12.p = _context12.n) {
        case 0:
          _context12.p = 0;
          corrected = (_ref45 = (_suggestion$meta$corr = (_suggestion$meta22 = suggestion.meta) === null || _suggestion$meta22 === void 0 ? void 0 : _suggestion$meta22.correctedText) !== null && _suggestion$meta$corr !== void 0 ? _suggestion$meta$corr : paragraph.text) !== null && _ref45 !== void 0 ? _ref45 : "";
          anchor = ((_suggestion$meta23 = suggestion.meta) === null || _suggestion$meta23 === void 0 ? void 0 : _suggestion$meta23.anchor) || {};
          entry = anchorProvider.getAnchorsForParagraph(suggestion.paragraphIndex);
          rawLeft = (_suggestion$snippets$ = (_suggestion$snippets = suggestion.snippets) === null || _suggestion$snippets === void 0 ? void 0 : _suggestion$snippets.leftSnippet) !== null && _suggestion$snippets$ !== void 0 ? _suggestion$snippets$ : corrected.slice(0, (_suggestion$meta$op$p = (_suggestion$meta24 = suggestion.meta) === null || _suggestion$meta24 === void 0 || (_suggestion$meta24 = _suggestion$meta24.op) === null || _suggestion$meta24 === void 0 ? void 0 : _suggestion$meta24.pos) !== null && _suggestion$meta$op$p !== void 0 ? _suggestion$meta$op$p : 0);
          rawRight = (_suggestion$snippets$2 = (_suggestion$snippets2 = suggestion.snippets) === null || _suggestion$snippets2 === void 0 ? void 0 : _suggestion$snippets2.rightSnippet) !== null && _suggestion$snippets$2 !== void 0 ? _suggestion$snippets$2 : corrected.slice((_suggestion$meta$op$p2 = (_suggestion$meta25 = suggestion.meta) === null || _suggestion$meta25 === void 0 || (_suggestion$meta25 = _suggestion$meta25.op) === null || _suggestion$meta25 === void 0 ? void 0 : _suggestion$meta25.pos) !== null && _suggestion$meta$op$p2 !== void 0 ? _suggestion$meta$op$p2 : 0);
        ...
        case 11:
          ...
          _context12.n = 12;
          return applySuggestionMarkerFormat(context, range, suggestion);
        case 12:
          applied = _context12.v;
          if (applied) {
            _context12.n = 13;
            break;
          }
        ...
        case 14:
          _context12.p = 14;
          _t9 = _context12.v;
          warn("highlightInsertSuggestion failed; skipping marker", _t9);
          return _context12.a(2, false);
      }
    }, _callee12, null, [[0, 14]]);
  }));
...
function findCommaRangeByOrdinal(_x46, _x47, _x48, _x49) {
  return _findCommaRangeByOrdinal.apply(this, arguments);
}
function _findCommaRangeByOrdinal() {
  _findCommaRangeByOrdinal = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13(context, paragraph, original, op) {
    var ordinal, commaSearch, _t0;
    return _regenerator().w(function (_context13) {
      while (1) switch (_context13.p = _context13.n) {
        ...
        case 2:
          ...
          return _context13.a(2, null);
        case 3:
          return _context13.a(2, commaSearch.items[ordinal - 1]);
        case 4:
          _context13.p = 4;
          _t0 = _context13.v;
          warn("findCommaRangeByOrdinal failed", _t0);
          return _context13.a(2, null);
      }
    }, _callee13, null, [[0, 4]]);
  }));
...
function tryApplyDeleteUsingMetadata(_x50, _x51, _x52) {
  return _tryApplyDeleteUsingMetadata.apply(this, arguments);
}
function _tryApplyDeleteUsingMetadata() {
  _tryApplyDeleteUsingMetadata = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14(context, paragraph, suggestion) {
    var _suggestion$meta26, _ref46, _ref47, _meta$sourceTokenAt4, _ref48, _ref49, _ref50, _suggestion$charHint$8, _suggestion$charHint0, _suggestion$meta27, _ref51, _suggestion$charHint$9, _suggestion$charHint1;
    ...
    return _regenerator().w(function (_context14) {
      while (1) switch (_context14.n) {
        case 0:
          meta = suggestion === null || suggestion === void 0 || (_suggestion$meta26 = suggestion.meta) === null || _suggestion$meta26 === void 0 ? void 0 : _suggestion$meta26.anchor;
          if (meta) {
            _context14.n = 1;
            break;
          }
        ...
        case 1:
          entry = anchorProvider.getAnchorsForParagraph(suggestion.paragraphIndex);
          sourceAnchor = (_ref46 = (_ref47 = (_meta$sourceTokenAt4 = meta.sourceTokenAt) !== null && _meta$sourceTokenAt4 !== void 0 ? _meta$sourceTokenAt4 : meta.sourceTokenBefore) !== null && _ref47 !== void 0 ? _ref47 : meta.sourceTokenAfter) !== null && _ref46 !== void 0 ? _ref46 : meta.highlightAnchorTarget;
          charStart = (_ref48 = (_ref49 = (_ref50 = (_suggestion$charHint$8 = (_suggestion$charHint0 = suggestion.charHint) === null || _suggestion$charHint0 === void 0 ? void 0 : _suggestion$charHint0.start) !== null && _suggestion$charHint$8 !== void 0 ? _suggestion$charHint$8 : meta.charStart) !== null && _ref50 !== void 0 ? _ref50 : sourceAnchor === null || sourceAnchor === void 0 ? void 0 : sourceAnchor.charStart) !== null && _ref49 !== void 0 ? _ref49 : (_suggestion$meta27 = suggestion.meta) === null || _suggestion$meta27 === void 0 || (_suggestion$meta27 = _suggestion$meta27.op) === null || _suggestion$meta27 === void 0 ? void 0 : _suggestion$meta27.originalPos) !== null && _ref48 !== void 0 ? _ref48 : -1;
          ...
          charEnd = (_ref51 = (_suggestion$charHint$9 = (_suggestion$charHint1 = suggestion.charHint) === null || _suggestion$charHint1 === void 0 ? void 0 : _suggestion$charHint1.end) !== null && _suggestion$charHint$9 !== void 0 ? _suggestion$charHint$9 : meta.charEnd) !== null && _ref51 !== void 0 ? _ref51 : fallbackEndFromToken;
          if (!(Number.isFinite(charStart) && charStart >= 0)) {
            _context14.n = 8;
            break;
          }
...
function tryApplyDeleteUsingHighlight(_x53, _x54, _x55) {
  return _tryApplyDeleteUsingHighlight.apply(this, arguments);
}
function _tryApplyDeleteUsingHighlight() {
  _tryApplyDeleteUsingHighlight = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee16(context, paragraph, suggestion) {
    var entry, tryByRange, candidates, i, candidate, safeEnd, span, _t10;
      ...
      while (1) switch (_context16.p = _context16.n) {
        case 0:
          ...
          tryByRange = /*#__PURE__*/function () {
            var _ref52 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee15(range) {
              var _t1;
              return _regenerator().w(function (_context15) {
                while (1) switch (_context15.p = _context15.n) {
                  ...
                  case 2:
                    _context15.p = 2;
                    _t1 = _context15.v;
                    warn("apply delete: highlight span removal failed", _t1);
                    return _context15.a(2, false);
                }
              }, _callee15, null, [[1, 2]]);
            }));
            return function tryByRange(_x100) {
        ...
        case 5:
          _context16.p = 5;
          _t10 = _context16.v;
          warn("apply delete: candidate span lookup failed", _t10);
          return _context16.a(3, 8);
        case 6:
          _context16.n = 7;
...
function applyDeleteSuggestionLegacy(_x56, _x57, _x58) {
  return _applyDeleteSuggestionLegacy.apply(this, arguments);
}
function _applyDeleteSuggestionLegacy() {
  _applyDeleteSuggestionLegacy = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee17(context, paragraph, suggestion) {
    var _ref53, _ref54, _suggestion$meta$op$o3, _suggestion$meta28, _suggestion$meta29, _suggestion$charHint10;
    var pos, ordinal, commaSearch, idx;
    return _regenerator().w(function (_context17) {
      while (1) switch (_context17.n) {
        case 0:
          pos = (_ref53 = (_ref54 = (_suggestion$meta$op$o3 = (_suggestion$meta28 = suggestion.meta) === null || _suggestion$meta28 === void 0 || (_suggestion$meta28 = _suggestion$meta28.op) === null || _suggestion$meta28 === void 0 ? void 0 : _suggestion$meta28.originalPos) !== null && _suggestion$meta$op$o3 !== void 0 ? _suggestion$meta$op$o3 : (_suggestion$meta29 = suggestion.meta) === null || _suggestion$meta29 === void 0 || (_suggestion$meta29 = _suggestion$meta29.op) === null || _suggestion$meta29 === void 0 ? void 0 : _suggestion$meta29.pos) !== null && _ref54 !== void 0 ? _ref54 : (_suggestion$charHint10 = suggestion.charHint) === null || _suggestion$charHint10 === void 0 ? void 0 : _suggestion$charHint10.start) !== null && _ref53 !== void 0 ? _ref53 : 0;
...
function applyDeleteSuggestion(_x59, _x60, _x61) {
  return _applyDeleteSuggestion.apply(this, arguments);
}
function _applyDeleteSuggestion() {
  _applyDeleteSuggestion = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee18(context, paragraph, suggestion) {
...
function findTokenRangeForAnchor(_x62, _x63, _x64) {
  return _findTokenRangeForAnchor.apply(this, arguments);
}
function _findTokenRangeForAnchor() {
  _findTokenRangeForAnchor = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee20(context, paragraph, anchorSnapshot) {
      ...
      while (1) switch (_context20.n) {
        ...
        case 1:
          ...
          tryFind = /*#__PURE__*/function () {
            var _ref55 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee19(text, ordinalHint) {
              ...
              return _regenerator().w(function (_context19) {
                while (1) switch (_context19.n) {
                  ...
                  case 3:
                    ...
                    return _context19.a(2, matches.items[targetIndex]);
                }
              }, _callee19);
            }));
            return function tryFind(_x101, _x102) {
...
function tryApplyInsertUsingMetadata(_x65, _x66, _x67) {
  return _tryApplyInsertUsingMetadata.apply(this, arguments);
}
function _tryApplyInsertUsingMetadata() {
  _tryApplyInsertUsingMetadata = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee25(context, paragraph, suggestion) {
    var _suggestion$meta30, _ref60, _ref61, _ref62, _meta$highlightAnchor, _suggestion$charHint$0, _suggestion$charHint11;
    var meta, entry, insertCommaAtChar, findTokenStartByHint, cleanWordToken, replaceGapBetweenAnchors, insertCommaAfterToken, insertCommaBeforeToken, anchor, anchorStart, anchorEnd, range, _meta$sourceTokenAfte4, _meta$sourceTokenBefo4, afterAnchor, beforeAnchor, _hasTokenAnchors, insertionCharStart, hasTokenAnchors, _t11, _t12;
    return _regenerator().w(function (_context25) {
      while (1) switch (_context25.p = _context25.n) {
        case 0:
          meta = suggestion === null || suggestion === void 0 || (_suggestion$meta30 = suggestion.meta) === null || _suggestion$meta30 === void 0 ? void 0 : _suggestion$meta30.anchor;
          if (meta) {
            _context25.n = 1;
            break;
          }
        ...
        case 1:
          ...
          insertCommaAtChar = /*#__PURE__*/function () {
            var _ref56 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee21(charIndex, traceLabel) {
              ...
              return _regenerator().w(function (_context21) {
                while (1) switch (_context21.n) {
                  ...
                  case 4:
                    replaceWhitespaceRange = _context21.v;
            ...
            return function insertCommaAtChar(_x103, _x104) {
          ...
          replaceGapBetweenAnchors = /*#__PURE__*/function () {
            var _ref57 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee22(beforeAnchor, afterAnchor, traceLabel) {
            ...
            return function replaceGapBetweenAnchors(_x105, _x106, _x107) {
              return _ref57.apply(this, arguments);
            };
          }();
          insertCommaAfterToken = /*#__PURE__*/function () {
            var _ref58 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee23(tokenAnchor, traceLabel) {
              ...
              return _regenerator().w(function (_context23) {
                while (1) switch (_context23.n) {
                  ...
                  case 3:
                    beforeTokenWsRange = _context23.v;
            ...
            return function insertCommaAfterToken(_x108, _x109) {
              return _ref58.apply(this, arguments);
            };
          }();
          insertCommaBeforeToken = /*#__PURE__*/function () {
            var _ref59 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee24(tokenAnchor, traceLabel) {
              ...
              return _regenerator().w(function (_context24) {
                while (1) switch (_context24.n) {
                  ...
                  case 2:
                    ...
                    return getRangeForAnchorSpan(context, paragraph, entry, wsStart, tokenStart, "".concat(traceLabel, "-normalize-before-token"), liveText.slice(wsStart, tokenStart));
                  case 3:
                    beforeTokenWsRange = _context24.v;
                    if (!beforeTokenWsRange) {
                      _context24.n = 4;
                      break;
                    }
            ...
            return function insertCommaBeforeToken(_x110, _x111) {
              return _ref59.apply(this, arguments);
            };
          }();
          anchor = (_ref60 = (_ref61 = (_ref62 = (_meta$highlightAnchor = meta.highlightAnchorTarget) !== null && _meta$highlightAnchor !== void 0 ? _meta$highlightAnchor : meta.sourceTokenAt) !== null && _ref62 !== void 0 ? _ref62 : meta.targetTokenAt) !== null && _ref61 !== void 0 ? _ref61 : meta.sourceTokenBefore) !== null && _ref60 !== void 0 ? _ref60 : meta.targetTokenBefore;
        ...
        case 2:
          ...
          _context25.p = 3;
          afterAnchor = (_meta$sourceTokenAfte4 = meta.sourceTokenAfter) !== null && _meta$sourceTokenAfte4 !== void 0 ? _meta$sourceTokenAfte4 : meta.targetTokenAfter;
          beforeAnchor = (_meta$sourceTokenBefo4 = meta.sourceTokenBefore) !== null && _meta$sourceTokenBefo4 !== void 0 ? _meta$sourceTokenBefo4 : meta.targetTokenBefore;
          _context25.n = 4;
        ...
        case 12:
          _context25.p = 12;
          _t11 = _context25.v;
          warn("apply insert metadata: failed to insert via lemma anchor", _t11);
        case 13:
          insertionCharStart = (_suggestion$charHint$0 = suggestion === null || suggestion === void 0 || (_suggestion$charHint11 = suggestion.charHint) === null || _suggestion$charHint11 === void 0 ? void 0 : _suggestion$charHint11.start) !== null && _suggestion$charHint$0 !== void 0 ? _suggestion$charHint$0 : Number.isFinite(meta.targetCharStart) ? meta.targetCharStart : -1;
        ...
        case 17:
          _context25.p = 17;
          _t12 = _context25.v;
          warn("apply insert metadata: failed to insert via target char", _t12);
          return _context25.a(2, false);
      }
    }, _callee25, null, [[15, 17], [3, 12]]);
  }));
  return _tryApplyInsertUsingMetadata.apply(this, arguments);
}
function applyInsertSuggestion(_x68, _x69, _x70) {
  return _applyInsertSuggestion.apply(this, arguments);
}
function _applyInsertSuggestion() {
  _applyInsertSuggestion = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee26(context, paragraph, suggestion) {
...
function normalizeCommaSpacingInParagraph(_x71, _x72) {
  return _normalizeCommaSpacingInParagraph.apply(this, arguments);
}
function _normalizeCommaSpacingInParagraph() {
  _normalizeCommaSpacingInParagraph = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee27(context, paragraph) {
...
function ensureCommaSpaceAfterInParagraph(_x73, _x74) {
  return _ensureCommaSpaceAfterInParagraph.apply(this, arguments);
}
function _ensureCommaSpaceAfterInParagraph() {
  _ensureCommaSpaceAfterInParagraph = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee28(context, paragraph) {
...
function cleanupCommaSpacingForParagraphs(_x75, _x76, _x77) {
  return _cleanupCommaSpacingForParagraphs.apply(this, arguments);
}
function _cleanupCommaSpacingForParagraphs() {
  _cleanupCommaSpacingForParagraphs = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee29(context, paragraphs, indexes) {
    var _ref63,
      _ref63$force,
      force,
      _iterator9,
    ...
    return _regenerator().w(function (_context29) {
      while (1) switch (_context29.p = _context29.n) {
        case 0:
          _ref63 = _args29.length > 3 && _args29[3] !== undefined ? _args29[3] : {}, _ref63$force = _ref63.force, force = _ref63$force === void 0 ? false : _ref63$force;
        ...
        case 1:
          ...
          return _context29.a(2);
        case 2:
          _iterator9 = _createForOfIteratorHelper(indexes);
          _context29.p = 3;
          _iterator9.s();
        case 4:
        ...
        case 7:
          _context29.p = 7;
          _t13 = _context29.v;
          warn("Failed to normalize comma spacing", _t13);
        case 8:
          _context29.n = 4;
          break;
        case 9:
    ...
    }, _callee29, null, [[5, 7], [3, 10, 11, 12]]);
  }));
  return _cleanupCommaSpacingForParagraphs.apply(this, arguments);
}
var HIGHLIGHT_SCRUB_DELIMITERS = [" ", "\t", "\r", "\n", ",", ".", ";", ":", "!", "?", "(", ")", "[", "]", "{", "}", "\"", "'", "«", "»", "…", "—", "–", "-"];
function clearResidualVejiceHighlightsInParagraph(_x78, _x79) {
  return _clearResidualVejiceHighlightsInParagraph.apply(this, arguments);
}
function _clearResidualVejiceHighlightsInParagraph() {
  _clearResidualVejiceHighlightsInParagraph = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee30(context, paragraph) {
    var _contentRange$font, _contentRange$font2, contentRange, textRanges, changed, _iterator0, _step0, _range$font, _range$font2, range, _t15;
    return _regenerator().w(function (_context30) {
      while (1) switch (_context30.p = _context30.n) {
        ...
        case 1:
          _context30.p = 1;
          contentRange = paragraph.getRange("Content");
          textRanges = contentRange.getTextRanges(HIGHLIGHT_SCRUB_DELIMITERS, false);
        ...
        case 2:
          changed = false;
          _iterator0 = _createForOfIteratorHelper(textRanges.items || []);
          try {
            for (_iterator0.s(); !(_step0 = _iterator0.n()).done;) {
              range = _step0.value;
              if (isVejiceMarkerStyle(range === null || range === void 0 || (_range$font = range.font) === null || _range$font === void 0 ? void 0 : _range$font.underline, null)) {
              ...
              if (isVejiceMarkerHighlightColor(range === null || range === void 0 || (_range$font2 = range.font) === null || _range$font2 === void 0 ? void 0 : _range$font2.highlightColor)) {
          ...
          if (isVejiceMarkerStyle(contentRange === null || contentRange === void 0 || (_contentRange$font = contentRange.font) === null || _contentRange$font === void 0 ? void 0 : _contentRange$font.underline, null)) {
          ...
          if (isVejiceMarkerHighlightColor(contentRange === null || contentRange === void 0 || (_contentRange$font2 = contentRange.font) === null || _contentRange$font2 === void 0 ? void 0 : _contentRange$font2.highlightColor)) {
        ...
        case 4:
          _context30.p = 4;
          _t15 = _context30.v;
          warn("Residual highlight scrub failed", _t15);
        case 5:
          return _context30.a(2);
      }
    }, _callee30, null, [[1, 4]]);
...
function clearResidualVejiceHighlightsForParagraphs(_x80, _x81, _x82) {
  return _clearResidualVejiceHighlightsForParagraphs.apply(this, arguments);
}
function _clearResidualVejiceHighlightsForParagraphs() {
  _clearResidualVejiceHighlightsForParagraphs = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee31(context, paragraphs, indexes) {
    var _iterator1, _step1, _paragraphs$items2, idx, paragraph, _t16;
    return _regenerator().w(function (_context31) {
      while (1) switch (_context31.p = _context31.n) {
        ...
        case 1:
          _iterator1 = _createForOfIteratorHelper(indexes);
          _context31.p = 2;
          _iterator1.s();
        case 3:
          ...
          idx = _step1.value;
          paragraph = paragraphs === null || paragraphs === void 0 || (_paragraphs$items2 = paragraphs.items) === null || _paragraphs$items2 === void 0 ? void 0 : _paragraphs$items2[idx];
          _context31.n = 4;
          return clearResidualVejiceHighlightsInParagraph(context, paragraph);
        case 4:
          _context31.n = 3;
          break;
        case 5:
...
function clearAllHighlightsForParagraphs(_x83, _x84, _x85) {
  return _clearAllHighlightsForParagraphs.apply(this, arguments);
}
function _clearAllHighlightsForParagraphs() {
  _clearAllHighlightsForParagraphs = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee32(context, paragraphs, indexes) {
    var _iterator10, _step10, _paragraphs$items3, idx, paragraph, _t17, _t18;
    return _regenerator().w(function (_context32) {
      while (1) switch (_context32.p = _context32.n) {
        ...
        case 1:
          _context32.p = 1;
          _iterator10 = _createForOfIteratorHelper(indexes);
          _context32.p = 2;
          _iterator10.s();
        case 3:
          ...
          idx = _step10.value;
          paragraph = paragraphs === null || paragraphs === void 0 || (_paragraphs$items3 = paragraphs.items) === null || _paragraphs$items3 === void 0 ? void 0 : _paragraphs$items3[idx];
          if (!(!paragraph || typeof paragraph.getRange !== "function")) {
            _context32.n = 4;
            break;
          }
        ...
        case 11:
          _context32.p = 11;
          _t18 = _context32.v;
          warn("clearAllHighlightsForParagraphs failed", _t18);
        case 12:
          return _context32.a(2);
      }
    }, _callee32, null, [[2, 7, 8, 9], [1, 11]]);
  }));
  return _clearAllHighlightsForParagraphs.apply(this, arguments);
}
function clearAddinMarkerFormattingOnRanges(_x86, _x87) {
  return _clearAddinMarkerFormattingOnRanges.apply(this, arguments);
}
function _clearAddinMarkerFormattingOnRanges() {
  _clearAddinMarkerFormattingOnRanges = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee33(context, ranges) {
    var validRanges, _iterator11, _step11, range, changed, _iterator12, _step12, _range$font3, _range$font4, _range, isHighlightMarker, isUnderlineMarker, _t19, _t20;
    return _regenerator().w(function (_context33) {
      while (1) switch (_context33.p = _context33.n) {
        case 0:
          validRanges = Array.isArray(ranges) ? ranges.filter(function (range) {
            return range && range.font;
          }) : [];
        ...
        case 1:
          _context33.p = 1;
          _iterator11 = _createForOfIteratorHelper(validRanges);
          try {
        ...
        case 2:
          changed = 0;
          _iterator12 = _createForOfIteratorHelper(validRanges);
          _context33.p = 3;
          _iterator12.s();
        case 4:
          ...
          _range = _step12.value;
          isHighlightMarker = isVejiceMarkerHighlightColor(_range === null || _range === void 0 || (_range$font3 = _range.font) === null || _range$font3 === void 0 ? void 0 : _range$font3.highlightColor);
          isUnderlineMarker = isVejiceMarkerStyle(_range === null || _range === void 0 || (_range$font4 = _range.font) === null || _range$font4 === void 0 ? void 0 : _range$font4.underline, null);
          if (!(!isHighlightMarker && !isUnderlineMarker)) {
            _context33.n = 5;
            break;
          }
        ...
        case 5:
          if (isHighlightMarker) {
            _range.font.highlightColor = null;
          }
          if (isUnderlineMarker) {
            _range.font.underline = "None";
            try {
              _range.font.underlineColor = null;
            } catch (_err) {
              // ignore: underlineColor not supported on some hosts
            }
          }
        ...
        case 10:
          ...
          return context.sync();
        case 11:
          return _context33.a(2, changed);
        case 12:
          _context33.p = 12;
          _t20 = _context33.v;
          warn("clearAddinMarkerFormattingOnRanges failed", _t20);
          return _context33.a(2, 0);
      }
    }, _callee33, null, [[3, 8, 9, 10], [1, 12]]);
  }));
  return _clearAddinMarkerFormattingOnRanges.apply(this, arguments);
}
function findRangeForInsert(_x88, _x89, _x90) {
  return _findRangeForInsert.apply(this, arguments);
}
function _findRangeForInsert() {
  _findRangeForInsert = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee34(context, paragraph, suggestion) {
    var _ref64, _suggestion$meta$corr2, _suggestion$meta31, _suggestion$snippets$3, _suggestion$snippets3, _suggestion$meta$op$p3, _suggestion$meta32, _suggestion$snippets$4, _suggestion$snippets4, _suggestion$meta$op$p4, _suggestion$meta33;
    var searchOpts, range, corrected, rawLeft, rawRight, lastWord, leftFrag, wordSearch, leftSearch, rightFrag, rightSearch;
    return _regenerator().w(function (_context34) {
      while (1) switch (_context34.n) {
        case 0:
          ...
          range = null;
          corrected = (_ref64 = (_suggestion$meta$corr2 = suggestion === null || suggestion === void 0 || (_suggestion$meta31 = suggestion.meta) === null || _suggestion$meta31 === void 0 ? void 0 : _suggestion$meta31.correctedText) !== null && _suggestion$meta$corr2 !== void 0 ? _suggestion$meta$corr2 : paragraph.text) !== null && _ref64 !== void 0 ? _ref64 : "";
          rawLeft = (_suggestion$snippets$3 = suggestion === null || suggestion === void 0 || (_suggestion$snippets3 = suggestion.snippets) === null || _suggestion$snippets3 === void 0 ? void 0 : _suggestion$snippets3.leftSnippet) !== null && _suggestion$snippets$3 !== void 0 ? _suggestion$snippets$3 : corrected.slice(0, (_suggestion$meta$op$p3 = suggestion === null || suggestion === void 0 || (_suggestion$meta32 = suggestion.meta) === null || _suggestion$meta32 === void 0 || (_suggestion$meta32 = _suggestion$meta32.op) === null || _suggestion$meta32 === void 0 ? void 0 : _suggestion$meta32.pos) !== null && _suggestion$meta$op$p3 !== void 0 ? _suggestion$meta$op$p3 : 0);
          rawRight = (_suggestion$snippets$4 = suggestion === null || suggestion === void 0 || (_suggestion$snippets4 = suggestion.snippets) === null || _suggestion$snippets4 === void 0 ? void 0 : _suggestion$snippets4.rightSnippet) !== null && _suggestion$snippets$4 !== void 0 ? _suggestion$snippets$4 : corrected.slice((_suggestion$meta$op$p4 = suggestion === null || suggestion === void 0 || (_suggestion$meta33 = suggestion.meta) === null || _suggestion$meta33 === void 0 || (_suggestion$meta33 = _suggestion$meta33.op) === null || _suggestion$meta33 === void 0 ? void 0 : _suggestion$meta33.pos) !== null && _suggestion$meta$op$p4 !== void 0 ? _suggestion$meta$op$p4 : 0);
          lastWord = extractLastWord(rawLeft || "");
          leftFrag = (rawLeft || "").slice(-20).replace(/[\r\n]+/g, " ");
          if (!lastWord) {
            _context34.n = 2;
            break;
          }
        ...
        case 4:
          ...
          rightFrag = (rawRight || "").replace(/,/g, "").trim();
...
function applyMarkerRestoreFormatting(range, suggestion) {
  if (!(range !== null && range !== void 0 && range.font) || !suggestion) return false;
  var restoreMarker = getSuggestionRestoreMarkerFormat(suggestion);
  var restoreWordUnderline = toWordUnderline(restoreMarker === null || restoreMarker === void 0 ? void 0 : restoreMarker.underline);
  var restoreWordUnderlineColor = normalizeHighlightColorValue(restoreMarker === null || restoreMarker === void 0 ? void 0 : restoreMarker.underlineColor);
...
function normalizeSuggestionClearEntry(item, paragraphs) {
  var _item$suggestion, _ref14, _item$paragraph, _paragraphs$items;
  var suggestion = (_item$suggestion = item === null || item === void 0 ? void 0 : item.suggestion) !== null && _item$suggestion !== void 0 ? _item$suggestion : item;
  if (!suggestion) return null;
  var paragraph = (_ref14 = (_item$paragraph = item === null || item === void 0 ? void 0 : item.paragraph) !== null && _item$paragraph !== void 0 ? _item$paragraph : paragraphs === null || paragraphs === void 0 || (_paragraphs$items = paragraphs.items) === null || _paragraphs$items === void 0 ? void 0 : _paragraphs$items[suggestion.paragraphIndex]) !== null && _ref14 !== void 0 ? _ref14 : null;
  return {
    suggestion: suggestion,
    paragraph: paragraph
  };
}
function clearSuggestionMarkersByTag(_x91, _x92) {
  return _clearSuggestionMarkersByTag.apply(this, arguments);
}
function _clearSuggestionMarkersByTag() {
  _clearSuggestionMarkersByTag = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee35(context, entries) {
    var normalizedEntries, taggedEntries, unresolvedEntries, _iterator13, _step13, _entry, markerTag, controls, clearedCount, changed, _i4, _taggedEntries, _entry$controls, entry, items, entryCleared, _iterator14, _step14, control, controlRange, _t21, _t22, _t23;
    return _regenerator().w(function (_context35) {
      while (1) switch (_context35.p = _context35.n) {
        case 0:
          normalizedEntries = Array.isArray(entries) ? entries.filter(function (entry) {
            return entry === null || entry === void 0 ? void 0 : entry.suggestion;
          }) : [];
        ...
        case 1:
          taggedEntries = [];
          unresolvedEntries = [];
          _iterator13 = _createForOfIteratorHelper(normalizedEntries);
          _context35.p = 2;
          _iterator13.s();
        case 3:
          ...
          _entry = _step13.value;
          markerTag = getSuggestionMarkerTag(_entry.suggestion, {
            create: false
          });
          if (markerTag) {
            _context35.n = 4;
          ...
          unresolvedEntries.push(_entry);
          return _context35.a(3, 5);
        case 4:
          try {
            controls = context.document.body.contentControls.getByTag(markerTag);
            controls.load("items");
            taggedEntries.push(_objectSpread(_objectSpread({}, _entry), {}, {
              controls: controls
            }));
          } catch (err) {
        ...
        case 12:
          _context35.p = 12;
          _t22 = _context35.v;
          warn("clearSuggestionMarkersByTag: failed to load tagged controls", _t22);
          return _context35.a(2, {
            clearedCount: 0,
            unresolvedEntries: [].concat(unresolvedEntries, _toConsumableArray(taggedEntries.map(function (entry) {
              return {
        ...
        case 13:
          clearedCount = 0;
          changed = false;
          _i4 = 0, _taggedEntries = taggedEntries;
        case 14:
          if (!(_i4 < _taggedEntries.length)) {
            _context35.n = 17;
            break;
          }
          entry = _taggedEntries[_i4];
          items = ((_entry$controls = entry.controls) === null || _entry$controls === void 0 ? void 0 : _entry$controls.items) || [];
          if (items.length) {
            _context35.n = 15;
            break;
          }
          ...
          return _context35.a(3, 16);
        case 15:
          entryCleared = false;
          _iterator14 = _createForOfIteratorHelper(items);
          try {
            for (_iterator14.s(); !(_step14 = _iterator14.n()).done;) {
              control = _step14.value;
              try {
                controlRange = control.getRange("Content");
        ...
        case 20:
          _context35.p = 20;
          _t23 = _context35.v;
          warn("clearSuggestionMarkersByTag: failed to commit marker cleanup", _t23);
        case 21:
          return _context35.a(2, {
    ...
    }, _callee35, null, [[18, 20], [10, 12], [2, 7, 8, 9]]);
  }));
  return _clearSuggestionMarkersByTag.apply(this, arguments);
}
function clearHighlightForSuggestion(_x93, _x94, _x95) {
  return _clearHighlightForSuggestion.apply(this, arguments);
}
function _clearHighlightForSuggestion() {
  _clearHighlightForSuggestion = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee36(context, paragraph, suggestion) {
    var _suggestion$meta34, _suggestion$charHint$1, _suggestion$charHint12, _suggestion$charHint$10, _suggestion$charHint13;
    var options,
      restoreMarker,
      restoreWordUnderline,
      restoreWordUnderlineColor,
      skipTagLookup,
      markerTag,
      controls,
      _iterator15,
      ...
      control,
      controlRange,
      clearedViaTrackedRange,
      entry,
      metaAnchor,
      charStart,
      charEnd,
      range,
      _metaAnchor$highlight,
      _suggestion$meta35,
      _suggestion$meta36,
      liveText,
      _args36 = arguments,
    ...
    return _regenerator().w(function (_context36) {
      while (1) switch (_context36.p = _context36.n) {
        ...
        case 1:
          restoreMarker = getSuggestionRestoreMarkerFormat(suggestion);
          restoreWordUnderline = toWordUnderline(restoreMarker === null || restoreMarker === void 0 ? void 0 : restoreMarker.underline);
          restoreWordUnderlineColor = normalizeHighlightColorValue(restoreMarker === null || restoreMarker === void 0 ? void 0 : restoreMarker.underlineColor);
          skipTagLookup = Boolean(options === null || options === void 0 ? void 0 : options.skipTagLookup);
          if (!((0,_utils_host_js__WEBPACK_IMPORTED_MODULE_1__.isWordOnline)() && !skipTagLookup)) {
            _context36.n = 7;
            break;
          }
          markerTag = getSuggestionMarkerTag(suggestion, {
        ...
        case 3:
          ...
          _iterator15 = _createForOfIteratorHelper(controls.items);
          try {
            for (_iterator15.s(); !(_step15 = _iterator15.n()).done;) {
              control = _step15.value;
              controlRange = control.getRange("Content");
              if (suggestion.markerChannel === "highlight") {
        ...
        case 6:
          _context36.p = 6;
          _t24 = _context36.v;
          warn("clearHighlightForSuggestion: failed via marker tag", _t24);
        case 7:
          if (!suggestion.highlightRange) {
            _context36.n = 8;
            break;
          }
          clearedViaTrackedRange = false;
          try {
            if (suggestion.markerChannel === "highlight") {
        ...
        case 8:
          entry = anchorProvider.getAnchorsForParagraph(suggestion.paragraphIndex);
          metaAnchor = (_suggestion$meta34 = suggestion.meta) === null || _suggestion$meta34 === void 0 ? void 0 : _suggestion$meta34.anchor;
          if (metaAnchor) {
            _context36.n = 9;
            break;
          }
          ...
          return _context36.a(2, false);
        case 9:
          charStart = (_suggestion$charHint$1 = (_suggestion$charHint12 = suggestion.charHint) === null || _suggestion$charHint12 === void 0 ? void 0 : _suggestion$charHint12.start) !== null && _suggestion$charHint$1 !== void 0 ? _suggestion$charHint$1 : typeof metaAnchor.highlightCharStart === "number" ? metaAnchor.highlightCharStart : metaAnchor.charStart;
          charEnd = (_suggestion$charHint$10 = (_suggestion$charHint13 = suggestion.charHint) === null || _suggestion$charHint13 === void 0 ? void 0 : _suggestion$charHint13.end) !== null && _suggestion$charHint$10 !== void 0 ? _suggestion$charHint$10 : typeof metaAnchor.highlightCharEnd === "number" ? metaAnchor.highlightCharEnd : metaAnchor.charEnd;
          if (paragraph) {
            _context36.n = 10;
            break;
          }
        ...
        case 11:
          range = _context36.v;
        case 12:
          if (!(!range && (suggestion === null || suggestion === void 0 ? void 0 : suggestion.kind) === "insert")) {
            _context36.n = 14;
            break;
          }
          _context36.n = 13;
        ...
        case 13:
          range = _context36.v;
        case 14:
          if (!(!range && (suggestion === null || suggestion === void 0 ? void 0 : suggestion.kind) === "delete")) {
            _context36.n = 16;
            break;
          }
          liveText = paragraph.text || (suggestion === null || suggestion === void 0 || (_suggestion$meta35 = suggestion.meta) === null || _suggestion$meta35 === void 0 ? void 0 : _suggestion$meta35.originalText) || "";
          _context36.n = 15;
          return findCommaRangeByOrdinal(context, paragraph, liveText, (suggestion === null || suggestion === void 0 || (_suggestion$meta36 = suggestion.meta) === null || _suggestion$meta36 === void 0 ? void 0 : _suggestion$meta36.op) || {});
        case 15:
          range = _context36.v;
        case 16:
          if (range) {
          ...
          resetSuggestionMarkerState(suggestion);
          return _context36.a(2, Boolean(range));
      }
    }, _callee36, null, [[2, 6]]);
  }));
  return _clearHighlightForSuggestion.apply(this, arguments);
}
function clearOnlineSuggestionMarkers(_x96, _x97, _x98) {
  return _clearOnlineSuggestionMarkers.apply(this, arguments);
}
function _clearOnlineSuggestionMarkers() {
  _clearOnlineSuggestionMarkers = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee37(context, suggestionsOverride, paragraphs) {
    var usingOverride, source, normalizedEntries, _iterator16, _step16, item, normalized, result, clearHighlight, taggedResult, needsFinalSync, _iterator17, _step17, entry, suggestion, paragraph, clearedBeforeTrackedFallback, cleared, _t25, _t26;
    return _regenerator().w(function (_context37) {
      while (1) switch (_context37.p = _context37.n) {
        case 0:
          ...
          normalizedEntries = [];
          _iterator16 = _createForOfIteratorHelper(source);
          try {
            for (_iterator16.s(); !(_step16 = _iterator16.n()).done;) {
              item = _step16.value;
              normalized = normalizeSuggestionClearEntry(item, paragraphs);
          ...
          return _context37.a(2, result);
        case 1:
          _context37.n = 2;
          return clearSuggestionMarkersByTag(context, normalizedEntries);
        case 2:
          taggedResult = _context37.v;
          result.clearedByTagCount = taggedResult.clearedCount;
          needsFinalSync = false;
          _iterator17 = _createForOfIteratorHelper(taggedResult.unresolvedEntries);
          _context37.p = 3;
          _iterator17.s();
        case 4:
          ...
          clearedBeforeTrackedFallback = result.clearedFallbackCount;
          _context37.n = 5;
          return clearHighlightForSuggestion(context, paragraph, suggestion, {
            skipTagLookup: true
          });
        case 5:
          cleared = _context37.v;
          if (cleared) {
            result.clearedFallbackCount += 1;
            needsFinalSync = true;
          }
        ...
        case 15:
          _context37.p = 15;
          _t26 = _context37.v;
          warn("clearOnlineSuggestionMarkers: final sync failed", _t26);
        case 16:
    ...
    }, _callee37, null, [[13, 15], [3, 10, 11, 12]]);
  }));
  return _clearOnlineSuggestionMarkers.apply(this, arguments);
}
function getSuggestionSortPos(suggestion) {
  var _ref15, _ref16, _ref17, _suggestion$meta$op$o2, _suggestion$meta0, _suggestion$meta1, _suggestion$meta10, _suggestion$charHint4;
  return (_ref15 = (_ref16 = (_ref17 = (_suggestion$meta$op$o2 = suggestion === null || suggestion === void 0 || (_suggestion$meta0 = suggestion.meta) === null || _suggestion$meta0 === void 0 || (_suggestion$meta0 = _suggestion$meta0.op) === null || _suggestion$meta0 === void 0 ? void 0 : _suggestion$meta0.originalPos) !== null && _suggestion$meta$op$o2 !== void 0 ? _suggestion$meta$op$o2 : suggestion === null || suggestion === void 0 || (_suggestion$meta1 = suggestion.meta) === null || _suggestion$meta1 === void 0 || (_suggestion$meta1 = _suggestion$meta1.op) === null || _suggestion$meta1 === void 0 ? void 0 : _suggestion$meta1.correctedPos) !== null && _ref17 !== void 0 ? _ref17 : suggestion === null || suggestion === void 0 || (_suggestion$meta10 = suggestion.meta) === null || _suggestion$meta10 === void 0 || (_suggestion$meta10 = _suggestion$meta10.op) === null || _suggestion$meta10 === void 0 ? void 0 : _suggestion$meta10.pos) !== null && _ref16 !== void 0 ? _ref16 : suggestion === null || suggestion === void 0 || (_suggestion$charHint4 = suggestion.charHint) === null || _suggestion$charHint4 === void 0 ? void 0 : _suggestion$charHint4.start) !== null && _ref15 !== void 0 ? _ref15 : -1;
}
...
var COMPANY_ABBREV_PATTERN = /\b(?:d\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*o\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*o\.|[s\u017F]\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*p\.|d\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*d\.|[k\u212A]\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*d\.|d\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*n\.[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*o\.)\b/i;
function resolveInsertOperationFromSnapshot(snapshotText, sourceText, suggestion) {
  var _suggestion$meta11, _meta$sourceTokenBefo, _meta$sourceTokenAfte;
  var meta = suggestion === null || suggestion === void 0 || (_suggestion$meta11 = suggestion.meta) === null || _suggestion$meta11 === void 0 ? void 0 : _suggestion$meta11.anchor;
  if (!meta) return {
    op: null,
    skipReason: "insert_missing_anchor_meta"
  };
  var skipReason = "insert_unresolved";
  ...
  var findStartForAnchor = function findStartForAnchor(anchor) {
    var _ref18, _anchor$textOccurrenc;
    var preferEnd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    var reasonOnMissing = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "insert_anchor_token_unresolved";
    ...
    var start = findWordTokenStartByHintInText(snapshotText, token, mappedHint, (_ref18 = (_anchor$textOccurrenc = anchor.textOccurrence) !== null && _anchor$textOccurrenc !== void 0 ? _anchor$textOccurrenc : anchor.tokenIndex) !== null && _ref18 !== void 0 ? _ref18 : 0);
    if (start < 0) {
  ...
  var hasCompanyAbbreviationNear = function hasCompanyAbbreviationNear(center) {
    var radius = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 72;
    if (!Number.isFinite(center) || center < 0 || center > snapshotText.length) return false;
    var start = Math.max(0, center - radius);
    var end = Math.min(snapshotText.length, center + radius);
    return COMPANY_ABBREV_PATTERN.test(snapshotText.slice(start, end));
  };
  var resolveCompanyInsertFallback = function resolveCompanyInsertFallback() {
    var _ref19, _ref20, _meta$sourceTokenAt, _ref21, _ref22, _ref23, _suggestion$charHint$3, _suggestion$charHint5, _suggestion$meta12;
    var sourceAnchor = (_ref19 = (_ref20 = (_meta$sourceTokenAt = meta.sourceTokenAt) !== null && _meta$sourceTokenAt !== void 0 ? _meta$sourceTokenAt : meta.sourceTokenBefore) !== null && _ref20 !== void 0 ? _ref20 : meta.sourceTokenAfter) !== null && _ref19 !== void 0 ? _ref19 : meta.highlightAnchorTarget;
    var charStart = (_ref21 = (_ref22 = (_ref23 = (_suggestion$charHint$3 = suggestion === null || suggestion === void 0 || (_suggestion$charHint5 = suggestion.charHint) === null || _suggestion$charHint5 === void 0 ? void 0 : _suggestion$charHint5.start) !== null && _suggestion$charHint$3 !== void 0 ? _suggestion$charHint$3 : meta.charStart) !== null && _ref23 !== void 0 ? _ref23 : sourceAnchor === null || sourceAnchor === void 0 ? void 0 : sourceAnchor.charStart) !== null && _ref22 !== void 0 ? _ref22 : suggestion === null || suggestion === void 0 || (_suggestion$meta12 = suggestion.meta) === null || _suggestion$meta12 === void 0 || (_suggestion$meta12 = _suggestion$meta12.op) === null || _suggestion$meta12 === void 0 ? void 0 : _suggestion$meta12.originalPos) !== null && _ref21 !== void 0 ? _ref21 : -1;
    if (!Number.isFinite(charStart) || charStart < 0) {
      skipReason = "insert_fallback_no_char_hint";
      return null;
    }
    var mapped = mapIndexAcrossCanonical(sourceText, snapshotText, charStart);
    ...
    var pos = mapped;
    if (pos > 0 && pos < snapshotText.length && /(?:[0-9A-Za-z\xAA\xB5\xBA\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0560-\u0588\u05D0-\u05EA\u05EF-\u05F2\u0620-\u064A\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07CA-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u0870-\u0887\u0889-\u088F\u08A0-\u08C9\u0904-\u0939\u093D\u0950\u0958-\u0961\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09F0\u09F1\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B71\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C5C\u0C5D\u0C60\u0C61\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDC-\u0CDE\u0CE0\u0CE1\u0CF1\u0CF2\u0D04-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D5F-\u0D61\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E81\u0E82\u0E84\u0E86-\u0E8A\u0E8C-\u0EA3\u0EA5\u0EA7-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0EDC-\u0EDF\u0F00\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16F1-\u16F8\u1700-\u1711\u171F-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u1820-\u1878\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1950-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u1A00-\u1A16\u1A20-\u1A54\u1AA7\u1B05-\u1B33\u1B45-\u1B4C\u1B83-\u1BA0\u1BAE\u1BAF\u1BBA-\u1BE5\u1C00-\u1C23\u1C4D-\u1C4F\u1C5A-\u1C7D\u1C80-\u1C8A\u1C90-\u1CBA\u1CBD-\u1CBF\u1CE9-\u1CEC\u1CEE-\u1CF3\u1CF5\u1CF6\u1CFA\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2071\u207F\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2183\u2184\u2C00-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005\u3006\u3031-\u3035\u303B\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312F\u3131-\u318E\u31A0-\u31BF\u31F0-\u31FF\u3400-\u4DBF\u4E00-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA61F\uA62A\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6E5\uA717-\uA71F\uA722-\uA788\uA78B-\uA7DC\uA7F1-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA840-\uA873\uA882-\uA8B3\uA8F2-\uA8F7\uA8FB\uA8FD\uA8FE\uA90A-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF\uA9E0-\uA9E4\uA9E6-\uA9EF\uA9FA-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB69\uAB70-\uABE2\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDE80-\uDE9C\uDEA0-\uDED0\uDF00-\uDF1F\uDF2D-\uDF40\uDF42-\uDF49\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF]|\uD801[\uDC00-\uDC9D\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDD70-\uDD7A\uDD7C-\uDD8A\uDD8C-\uDD92\uDD94\uDD95\uDD97-\uDDA1\uDDA3-\uDDB1\uDDB3-\uDDB9\uDDBB\uDDBC\uDDC0-\uDDF3\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67\uDF80-\uDF85\uDF87-\uDFB0\uDFB2-\uDFBA]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC60-\uDC76\uDC80-\uDC9E\uDCE0-\uDCF2\uDCF4\uDCF5\uDD00-\uDD15\uDD20-\uDD39\uDD40-\uDD59\uDD80-\uDDB7\uDDBE\uDDBF\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE35\uDE60-\uDE7C\uDE80-\uDE9C\uDEC0-\uDEC7\uDEC9-\uDEE4\uDF00-\uDF35\uDF40-\uDF55\uDF60-\uDF72\uDF80-\uDF91]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2\uDD00-\uDD23\uDD4A-\uDD65\uDD6F-\uDD85\uDE80-\uDEA9\uDEB0\uDEB1\uDEC2-\uDEC7\uDF00-\uDF1C\uDF27\uDF30-\uDF45\uDF70-\uDF81\uDFB0-\uDFC4\uDFE0-\uDFF6]|\uD804[\uDC03-\uDC37\uDC71\uDC72\uDC75\uDC83-\uDCAF\uDCD0-\uDCE8\uDD03-\uDD26\uDD44\uDD47\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDDA\uDDDC\uDE00-\uDE11\uDE13-\uDE2B\uDE3F\uDE40\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61\uDF80-\uDF89\uDF8B\uDF8E\uDF90-\uDFB5\uDFB7\uDFD1\uDFD3]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC5F-\uDC61\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE80-\uDEAA\uDEB8\uDF00-\uDF1A\uDF40-\uDF46]|\uD806[\uDC00-\uDC2B\uDCA0-\uDCDF\uDCFF-\uDD06\uDD09\uDD0C-\uDD13\uDD15\uDD16\uDD18-\uDD2F\uDD3F\uDD41\uDDA0-\uDDA7\uDDAA-\uDDD0\uDDE1\uDDE3\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE89\uDE9D\uDEB0-\uDEF8\uDFC0-\uDFE0]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46\uDD60-\uDD65\uDD67\uDD68\uDD6A-\uDD89\uDD98\uDDB0-\uDDDB\uDEE0-\uDEF2\uDF02\uDF04-\uDF10\uDF12-\uDF33\uDFB0]|\uD808[\uDC00-\uDF99]|\uD809[\uDC80-\uDD43]|\uD80B[\uDF90-\uDFF0]|[\uD80C\uD80E\uD80F\uD81C-\uD822\uD840-\uD868\uD86A-\uD86D\uD86F-\uD872\uD874-\uD879\uD880-\uD883\uD885-\uD88C][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2F\uDC41-\uDC46\uDC60-\uDFFF]|\uD810[\uDC00-\uDFFA]|\uD811[\uDC00-\uDE46]|\uD818[\uDD00-\uDD1D]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE70-\uDEBE\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDD40-\uDD6C\uDE40-\uDE7F\uDEA0-\uDEB8\uDEBB-\uDED3\uDF00-\uDF4A\uDF50\uDF93-\uDF9F\uDFE0\uDFE1\uDFE3\uDFF2\uDFF3]|\uD823[\uDC00-\uDCD5\uDCFF-\uDD1E\uDD80-\uDDF2]|\uD82B[\uDFF0-\uDFF3\uDFF5-\uDFFB\uDFFD\uDFFE]|\uD82C[\uDC00-\uDD22\uDD32\uDD50-\uDD52\uDD55\uDD64-\uDD67\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB]|\uD837[\uDF00-\uDF1E\uDF25-\uDF2A]|\uD838[\uDC30-\uDC6D\uDD00-\uDD2C\uDD37-\uDD3D\uDD4E\uDE90-\uDEAD\uDEC0-\uDEEB]|\uD839[\uDCD0-\uDCEB\uDDD0-\uDDED\uDDF0\uDEC0-\uDEDE\uDEE0-\uDEE2\uDEE4\uDEE5\uDEE7-\uDEED\uDEF0-\uDEF4\uDEFE\uDEFF\uDFE0-\uDFE6\uDFE8-\uDFEB\uDFED\uDFEE\uDFF0-\uDFFE]|\uD83A[\uDC00-\uDCC4\uDD00-\uDD43\uDD4B]|\uD83B[\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD869[\uDC00-\uDEDF\uDF00-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEAD\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0\uDFF0-\uDFFF]|\uD87B[\uDC00-\uDE5D]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A\uDF50-\uDFFF]|\uD88D[\uDC00-\uDC79])/.test(snapshotText[pos - 1]) && /(?:[0-9A-Za-z\xAA\xB5\xBA\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0560-\u0588\u05D0-\u05EA\u05EF-\u05F2\u0620-\u064A\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07CA-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u0870-\u0887\u0889-\u088F\u08A0-\u08C9\u0904-\u0939\u093D\u0950\u0958-\u0961\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09F0\u09F1\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B71\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C5C\u0C5D\u0C60\u0C61\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDC-\u0CDE\u0CE0\u0CE1\u0CF1\u0CF2\u0D04-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D5F-\u0D61\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E81\u0E82\u0E84\u0E86-\u0E8A\u0E8C-\u0EA3\u0EA5\u0EA7-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0EDC-\u0EDF\u0F00\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16F1-\u16F8\u1700-\u1711\u171F-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u1820-\u1878\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1950-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u1A00-\u1A16\u1A20-\u1A54\u1AA7\u1B05-\u1B33\u1B45-\u1B4C\u1B83-\u1BA0\u1BAE\u1BAF\u1BBA-\u1BE5\u1C00-\u1C23\u1C4D-\u1C4F\u1C5A-\u1C7D\u1C80-\u1C8A\u1C90-\u1CBA\u1CBD-\u1CBF\u1CE9-\u1CEC\u1CEE-\u1CF3\u1CF5\u1CF6\u1CFA\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2071\u207F\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2183\u2184\u2C00-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005\u3006\u3031-\u3035\u303B\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312F\u3131-\u318E\u31A0-\u31BF\u31F0-\u31FF\u3400-\u4DBF\u4E00-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA61F\uA62A\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6E5\uA717-\uA71F\uA722-\uA788\uA78B-\uA7DC\uA7F1-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA840-\uA873\uA882-\uA8B3\uA8F2-\uA8F7\uA8FB\uA8FD\uA8FE\uA90A-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF\uA9E0-\uA9E4\uA9E6-\uA9EF\uA9FA-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB69\uAB70-\uABE2\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDE80-\uDE9C\uDEA0-\uDED0\uDF00-\uDF1F\uDF2D-\uDF40\uDF42-\uDF49\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF]|\uD801[\uDC00-\uDC9D\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDD70-\uDD7A\uDD7C-\uDD8A\uDD8C-\uDD92\uDD94\uDD95\uDD97-\uDDA1\uDDA3-\uDDB1\uDDB3-\uDDB9\uDDBB\uDDBC\uDDC0-\uDDF3\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67\uDF80-\uDF85\uDF87-\uDFB0\uDFB2-\uDFBA]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC60-\uDC76\uDC80-\uDC9E\uDCE0-\uDCF2\uDCF4\uDCF5\uDD00-\uDD15\uDD20-\uDD39\uDD40-\uDD59\uDD80-\uDDB7\uDDBE\uDDBF\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE35\uDE60-\uDE7C\uDE80-\uDE9C\uDEC0-\uDEC7\uDEC9-\uDEE4\uDF00-\uDF35\uDF40-\uDF55\uDF60-\uDF72\uDF80-\uDF91]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2\uDD00-\uDD23\uDD4A-\uDD65\uDD6F-\uDD85\uDE80-\uDEA9\uDEB0\uDEB1\uDEC2-\uDEC7\uDF00-\uDF1C\uDF27\uDF30-\uDF45\uDF70-\uDF81\uDFB0-\uDFC4\uDFE0-\uDFF6]|\uD804[\uDC03-\uDC37\uDC71\uDC72\uDC75\uDC83-\uDCAF\uDCD0-\uDCE8\uDD03-\uDD26\uDD44\uDD47\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDDA\uDDDC\uDE00-\uDE11\uDE13-\uDE2B\uDE3F\uDE40\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61\uDF80-\uDF89\uDF8B\uDF8E\uDF90-\uDFB5\uDFB7\uDFD1\uDFD3]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC5F-\uDC61\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE80-\uDEAA\uDEB8\uDF00-\uDF1A\uDF40-\uDF46]|\uD806[\uDC00-\uDC2B\uDCA0-\uDCDF\uDCFF-\uDD06\uDD09\uDD0C-\uDD13\uDD15\uDD16\uDD18-\uDD2F\uDD3F\uDD41\uDDA0-\uDDA7\uDDAA-\uDDD0\uDDE1\uDDE3\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE89\uDE9D\uDEB0-\uDEF8\uDFC0-\uDFE0]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46\uDD60-\uDD65\uDD67\uDD68\uDD6A-\uDD89\uDD98\uDDB0-\uDDDB\uDEE0-\uDEF2\uDF02\uDF04-\uDF10\uDF12-\uDF33\uDFB0]|\uD808[\uDC00-\uDF99]|\uD809[\uDC80-\uDD43]|\uD80B[\uDF90-\uDFF0]|[\uD80C\uD80E\uD80F\uD81C-\uD822\uD840-\uD868\uD86A-\uD86D\uD86F-\uD872\uD874-\uD879\uD880-\uD883\uD885-\uD88C][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2F\uDC41-\uDC46\uDC60-\uDFFF]|\uD810[\uDC00-\uDFFA]|\uD811[\uDC00-\uDE46]|\uD818[\uDD00-\uDD1D]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE70-\uDEBE\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDD40-\uDD6C\uDE40-\uDE7F\uDEA0-\uDEB8\uDEBB-\uDED3\uDF00-\uDF4A\uDF50\uDF93-\uDF9F\uDFE0\uDFE1\uDFE3\uDFF2\uDFF3]|\uD823[\uDC00-\uDCD5\uDCFF-\uDD1E\uDD80-\uDDF2]|\uD82B[\uDFF0-\uDFF3\uDFF5-\uDFFB\uDFFD\uDFFE]|\uD82C[\uDC00-\uDD22\uDD32\uDD50-\uDD52\uDD55\uDD64-\uDD67\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB]|\uD837[\uDF00-\uDF1E\uDF25-\uDF2A]|\uD838[\uDC30-\uDC6D\uDD00-\uDD2C\uDD37-\uDD3D\uDD4E\uDE90-\uDEAD\uDEC0-\uDEEB]|\uD839[\uDCD0-\uDCEB\uDDD0-\uDDED\uDDF0\uDEC0-\uDEDE\uDEE0-\uDEE2\uDEE4\uDEE5\uDEE7-\uDEED\uDEF0-\uDEF4\uDEFE\uDEFF\uDFE0-\uDFE6\uDFE8-\uDFEB\uDFED\uDFEE\uDFF0-\uDFFE]|\uD83A[\uDC00-\uDCC4\uDD00-\uDD43\uDD4B]|\uD83B[\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD869[\uDC00-\uDEDF\uDF00-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEAD\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0\uDFF0-\uDFFF]|\uD87B[\uDC00-\uDE5D]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A\uDF50-\uDFFF]|\uD88D[\uDC00-\uDC79])/.test(snapshotText[pos])) {
      while (pos < snapshotText.length && /(?:[\.0-9A-Za-z\xAA\xB5\xBA\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0560-\u0588\u05D0-\u05EA\u05EF-\u05F2\u0620-\u064A\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07CA-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u0870-\u0887\u0889-\u088F\u08A0-\u08C9\u0904-\u0939\u093D\u0950\u0958-\u0961\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09F0\u09F1\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B71\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C5C\u0C5D\u0C60\u0C61\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDC-\u0CDE\u0CE0\u0CE1\u0CF1\u0CF2\u0D04-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D5F-\u0D61\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E81\u0E82\u0E84\u0E86-\u0E8A\u0E8C-\u0EA3\u0EA5\u0EA7-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0EDC-\u0EDF\u0F00\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16F1-\u16F8\u1700-\u1711\u171F-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u1820-\u1878\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1950-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u1A00-\u1A16\u1A20-\u1A54\u1AA7\u1B05-\u1B33\u1B45-\u1B4C\u1B83-\u1BA0\u1BAE\u1BAF\u1BBA-\u1BE5\u1C00-\u1C23\u1C4D-\u1C4F\u1C5A-\u1C7D\u1C80-\u1C8A\u1C90-\u1CBA\u1CBD-\u1CBF\u1CE9-\u1CEC\u1CEE-\u1CF3\u1CF5\u1CF6\u1CFA\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2071\u207F\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2183\u2184\u2C00-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005\u3006\u3031-\u3035\u303B\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312F\u3131-\u318E\u31A0-\u31BF\u31F0-\u31FF\u3400-\u4DBF\u4E00-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA61F\uA62A\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6E5\uA717-\uA71F\uA722-\uA788\uA78B-\uA7DC\uA7F1-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA840-\uA873\uA882-\uA8B3\uA8F2-\uA8F7\uA8FB\uA8FD\uA8FE\uA90A-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF\uA9E0-\uA9E4\uA9E6-\uA9EF\uA9FA-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB69\uAB70-\uABE2\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDE80-\uDE9C\uDEA0-\uDED0\uDF00-\uDF1F\uDF2D-\uDF40\uDF42-\uDF49\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF]|\uD801[\uDC00-\uDC9D\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDD70-\uDD7A\uDD7C-\uDD8A\uDD8C-\uDD92\uDD94\uDD95\uDD97-\uDDA1\uDDA3-\uDDB1\uDDB3-\uDDB9\uDDBB\uDDBC\uDDC0-\uDDF3\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67\uDF80-\uDF85\uDF87-\uDFB0\uDFB2-\uDFBA]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC60-\uDC76\uDC80-\uDC9E\uDCE0-\uDCF2\uDCF4\uDCF5\uDD00-\uDD15\uDD20-\uDD39\uDD40-\uDD59\uDD80-\uDDB7\uDDBE\uDDBF\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE35\uDE60-\uDE7C\uDE80-\uDE9C\uDEC0-\uDEC7\uDEC9-\uDEE4\uDF00-\uDF35\uDF40-\uDF55\uDF60-\uDF72\uDF80-\uDF91]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2\uDD00-\uDD23\uDD4A-\uDD65\uDD6F-\uDD85\uDE80-\uDEA9\uDEB0\uDEB1\uDEC2-\uDEC7\uDF00-\uDF1C\uDF27\uDF30-\uDF45\uDF70-\uDF81\uDFB0-\uDFC4\uDFE0-\uDFF6]|\uD804[\uDC03-\uDC37\uDC71\uDC72\uDC75\uDC83-\uDCAF\uDCD0-\uDCE8\uDD03-\uDD26\uDD44\uDD47\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDDA\uDDDC\uDE00-\uDE11\uDE13-\uDE2B\uDE3F\uDE40\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61\uDF80-\uDF89\uDF8B\uDF8E\uDF90-\uDFB5\uDFB7\uDFD1\uDFD3]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC5F-\uDC61\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE80-\uDEAA\uDEB8\uDF00-\uDF1A\uDF40-\uDF46]|\uD806[\uDC00-\uDC2B\uDCA0-\uDCDF\uDCFF-\uDD06\uDD09\uDD0C-\uDD13\uDD15\uDD16\uDD18-\uDD2F\uDD3F\uDD41\uDDA0-\uDDA7\uDDAA-\uDDD0\uDDE1\uDDE3\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE89\uDE9D\uDEB0-\uDEF8\uDFC0-\uDFE0]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46\uDD60-\uDD65\uDD67\uDD68\uDD6A-\uDD89\uDD98\uDDB0-\uDDDB\uDEE0-\uDEF2\uDF02\uDF04-\uDF10\uDF12-\uDF33\uDFB0]|\uD808[\uDC00-\uDF99]|\uD809[\uDC80-\uDD43]|\uD80B[\uDF90-\uDFF0]|[\uD80C\uD80E\uD80F\uD81C-\uD822\uD840-\uD868\uD86A-\uD86D\uD86F-\uD872\uD874-\uD879\uD880-\uD883\uD885-\uD88C][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2F\uDC41-\uDC46\uDC60-\uDFFF]|\uD810[\uDC00-\uDFFA]|\uD811[\uDC00-\uDE46]|\uD818[\uDD00-\uDD1D]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE70-\uDEBE\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDD40-\uDD6C\uDE40-\uDE7F\uDEA0-\uDEB8\uDEBB-\uDED3\uDF00-\uDF4A\uDF50\uDF93-\uDF9F\uDFE0\uDFE1\uDFE3\uDFF2\uDFF3]|\uD823[\uDC00-\uDCD5\uDCFF-\uDD1E\uDD80-\uDDF2]|\uD82B[\uDFF0-\uDFF3\uDFF5-\uDFFB\uDFFD\uDFFE]|\uD82C[\uDC00-\uDD22\uDD32\uDD50-\uDD52\uDD55\uDD64-\uDD67\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB]|\uD837[\uDF00-\uDF1E\uDF25-\uDF2A]|\uD838[\uDC30-\uDC6D\uDD00-\uDD2C\uDD37-\uDD3D\uDD4E\uDE90-\uDEAD\uDEC0-\uDEEB]|\uD839[\uDCD0-\uDCEB\uDDD0-\uDDED\uDDF0\uDEC0-\uDEDE\uDEE0-\uDEE2\uDEE4\uDEE5\uDEE7-\uDEED\uDEF0-\uDEF4\uDEFE\uDEFF\uDFE0-\uDFE6\uDFE8-\uDFEB\uDFED\uDFEE\uDFF0-\uDFFE]|\uD83A[\uDC00-\uDCC4\uDD00-\uDD43\uDD4B]|\uD83B[\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD869[\uDC00-\uDEDF\uDF00-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEAD\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0\uDFF0-\uDFFF]|\uD87B[\uDC00-\uDE5D]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A\uDF50-\uDFFF]|\uD88D[\uDC00-\uDC79])/.test(snapshotText[pos])) pos++;
    }
    pos = normalizeInsertPosForQuoteBoundary(Math.max(0, Math.min(snapshotText.length, pos)));
    var left = snapshotText.slice(Math.max(0, pos - 3), pos);
    var right = snapshotText.slice(pos, Math.min(snapshotText.length, pos + 3));
  ...
  if (beforeAnchor && afterAnchor) {
    var before = findStartForAnchor(beforeAnchor, true, "insert_before_anchor_lookup_failed");
    var after = findStartForAnchor(afterAnchor, false, "insert_after_anchor_lookup_failed");
  ...
  if (afterAnchor) {
    var _after = findStartForAnchor(afterAnchor, false, "insert_after_anchor_lookup_failed");
    if (_after.start > 0) {
  ...
  if (beforeAnchor) {
    var _before = findStartForAnchor(beforeAnchor, true, "insert_before_anchor_lookup_failed");
    if (_before.start >= 0) {
  ...
  var fallbackOp = resolveCompanyInsertFallback();
  if (fallbackOp) return {
    op: fallbackOp,
    skipReason: null
  };
  return {
...
function isProtectedAbbreviationComma() {
  var snapshotText = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  var commaIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : -1;
  ...
  var left = snapshotText.slice(Math.max(0, commaIndex - 24), commaIndex + 1);
  var normalized = left.replace(/\s+/g, "");
  return /\b(?:itd|itn|ipd|idr|npr|oz|tj|dr|mr|ga|go[s\u017F]|prim|prof|doc|mag)\.,$/i.test(normalized);
}
...
function isSafeGapBetweenTokenAndComma() {
  var gap = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
...
function hasStrongDeleteContext(snapshotText, sourceText, suggestion, commaIndex) {
  var _suggestion$meta13, _ref24, _ref25, _meta$sourceTokenBefo2, _ref26, _ref27, _meta$sourceTokenAfte2;
  var meta = suggestion === null || suggestion === void 0 || (_suggestion$meta13 = suggestion.meta) === null || _suggestion$meta13 === void 0 ? void 0 : _suggestion$meta13.anchor;
  if (!meta || typeof snapshotText !== "string" || !snapshotText) return false;
  var beforeAnchor = (_ref24 = (_ref25 = (_meta$sourceTokenBefo2 = meta.sourceTokenBefore) !== null && _meta$sourceTokenBefo2 !== void 0 ? _meta$sourceTokenBefo2 : meta.sourceTokenAt) !== null && _ref25 !== void 0 ? _ref25 : meta.highlightAnchorTarget) !== null && _ref24 !== void 0 ? _ref24 : null;
  var afterAnchor = (_ref26 = (_ref27 = (_meta$sourceTokenAfte2 = meta.sourceTokenAfter) !== null && _meta$sourceTokenAfte2 !== void 0 ? _meta$sourceTokenAfte2 : meta.sourceTokenAt) !== null && _ref27 !== void 0 ? _ref27 : meta.highlightAnchorTarget) !== null && _ref26 !== void 0 ? _ref26 : null;
  var checked = 0;
  if (beforeAnchor !== null && beforeAnchor !== void 0 && beforeAnchor.tokenText) {
    var token = normalizeDeleteContextToken(beforeAnchor.tokenText);
    if (token) {
      var _ref28, _beforeAnchor$textOcc;
      var sourceHint = Number.isFinite(beforeAnchor.charStart) ? beforeAnchor.charStart : Number.isFinite(beforeAnchor.charEnd) ? beforeAnchor.charEnd - token.length : null;
      var mappedHint = Number.isFinite(sourceHint) && typeof sourceText === "string" ? mapIndexAcrossCanonical(sourceText, snapshotText, sourceHint) : null;
      var start = findWordTokenStartByHintInText(snapshotText, token, mappedHint, (_ref28 = (_beforeAnchor$textOcc = beforeAnchor.textOccurrence) !== null && _beforeAnchor$textOcc !== void 0 ? _beforeAnchor$textOcc : beforeAnchor.tokenIndex) !== null && _ref28 !== void 0 ? _ref28 : 0);
      checked++;
      if (start < 0) return false;
      var end = start + token.length;
      var gap = snapshotText.slice(end, commaIndex);
      if (end > commaIndex || !isSafeGapBetweenTokenAndComma(gap, "before")) return false;
    }
  }
  if (afterAnchor !== null && afterAnchor !== void 0 && afterAnchor.tokenText) {
    var _token = normalizeDeleteContextToken(afterAnchor.tokenText);
    if (_token) {
      var _ref29, _afterAnchor$textOccu;
      var _sourceHint = Number.isFinite(afterAnchor.charStart) ? afterAnchor.charStart : Number.isFinite(afterAnchor.charEnd) ? afterAnchor.charEnd - _token.length : null;
      var _mappedHint = Number.isFinite(_sourceHint) && typeof sourceText === "string" ? mapIndexAcrossCanonical(sourceText, snapshotText, _sourceHint) : null;
      var _start = findWordTokenStartByHintInText(snapshotText, _token, _mappedHint, (_ref29 = (_afterAnchor$textOccu = afterAnchor.textOccurrence) !== null && _afterAnchor$textOccu !== void 0 ? _afterAnchor$textOccu : afterAnchor.tokenIndex) !== null && _ref29 !== void 0 ? _ref29 : 0);
      checked++;
      if (_start < 0) return false;
      var _gap = snapshotText.slice(commaIndex + 1, _start);
      if (_start <= commaIndex || !isSafeGapBetweenTokenAndComma(_gap, "after")) return false;
    }
  }
...
function hasWordBoundaryAroundComma(snapshotText, commaIndex) {
  ...
  var leftIdx = findNearestNonSpaceIndex(snapshotText, commaIndex - 1, -1);
  var rightIdx = findNearestNonSpaceIndex(snapshotText, commaIndex + 1, 1);
  if (leftIdx < 0 || rightIdx < 0) return false;
  return /(?:[A-Za-z\xAA\xB5\xBA\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0560-\u0588\u05D0-\u05EA\u05EF-\u05F2\u0620-\u064A\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07CA-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u0870-\u0887\u0889-\u088F\u08A0-\u08C9\u0904-\u0939\u093D\u0950\u0958-\u0961\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09F0\u09F1\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B71\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C5C\u0C5D\u0C60\u0C61\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDC-\u0CDE\u0CE0\u0CE1\u0CF1\u0CF2\u0D04-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D5F-\u0D61\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E81\u0E82\u0E84\u0E86-\u0E8A\u0E8C-\u0EA3\u0EA5\u0EA7-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0EDC-\u0EDF\u0F00\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16F1-\u16F8\u1700-\u1711\u171F-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u1820-\u1878\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1950-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u1A00-\u1A16\u1A20-\u1A54\u1AA7\u1B05-\u1B33\u1B45-\u1B4C\u1B83-\u1BA0\u1BAE\u1BAF\u1BBA-\u1BE5\u1C00-\u1C23\u1C4D-\u1C4F\u1C5A-\u1C7D\u1C80-\u1C8A\u1C90-\u1CBA\u1CBD-\u1CBF\u1CE9-\u1CEC\u1CEE-\u1CF3\u1CF5\u1CF6\u1CFA\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2071\u207F\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2183\u2184\u2C00-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005\u3006\u3031-\u3035\u303B\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312F\u3131-\u318E\u31A0-\u31BF\u31F0-\u31FF\u3400-\u4DBF\u4E00-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA61F\uA62A\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6E5\uA717-\uA71F\uA722-\uA788\uA78B-\uA7DC\uA7F1-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA840-\uA873\uA882-\uA8B3\uA8F2-\uA8F7\uA8FB\uA8FD\uA8FE\uA90A-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF\uA9E0-\uA9E4\uA9E6-\uA9EF\uA9FA-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB69\uAB70-\uABE2\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDE80-\uDE9C\uDEA0-\uDED0\uDF00-\uDF1F\uDF2D-\uDF40\uDF42-\uDF49\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF]|\uD801[\uDC00-\uDC9D\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDD70-\uDD7A\uDD7C-\uDD8A\uDD8C-\uDD92\uDD94\uDD95\uDD97-\uDDA1\uDDA3-\uDDB1\uDDB3-\uDDB9\uDDBB\uDDBC\uDDC0-\uDDF3\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67\uDF80-\uDF85\uDF87-\uDFB0\uDFB2-\uDFBA]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC60-\uDC76\uDC80-\uDC9E\uDCE0-\uDCF2\uDCF4\uDCF5\uDD00-\uDD15\uDD20-\uDD39\uDD40-\uDD59\uDD80-\uDDB7\uDDBE\uDDBF\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE35\uDE60-\uDE7C\uDE80-\uDE9C\uDEC0-\uDEC7\uDEC9-\uDEE4\uDF00-\uDF35\uDF40-\uDF55\uDF60-\uDF72\uDF80-\uDF91]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2\uDD00-\uDD23\uDD4A-\uDD65\uDD6F-\uDD85\uDE80-\uDEA9\uDEB0\uDEB1\uDEC2-\uDEC7\uDF00-\uDF1C\uDF27\uDF30-\uDF45\uDF70-\uDF81\uDFB0-\uDFC4\uDFE0-\uDFF6]|\uD804[\uDC03-\uDC37\uDC71\uDC72\uDC75\uDC83-\uDCAF\uDCD0-\uDCE8\uDD03-\uDD26\uDD44\uDD47\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDDA\uDDDC\uDE00-\uDE11\uDE13-\uDE2B\uDE3F\uDE40\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61\uDF80-\uDF89\uDF8B\uDF8E\uDF90-\uDFB5\uDFB7\uDFD1\uDFD3]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC5F-\uDC61\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE80-\uDEAA\uDEB8\uDF00-\uDF1A\uDF40-\uDF46]|\uD806[\uDC00-\uDC2B\uDCA0-\uDCDF\uDCFF-\uDD06\uDD09\uDD0C-\uDD13\uDD15\uDD16\uDD18-\uDD2F\uDD3F\uDD41\uDDA0-\uDDA7\uDDAA-\uDDD0\uDDE1\uDDE3\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE89\uDE9D\uDEB0-\uDEF8\uDFC0-\uDFE0]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46\uDD60-\uDD65\uDD67\uDD68\uDD6A-\uDD89\uDD98\uDDB0-\uDDDB\uDEE0-\uDEF2\uDF02\uDF04-\uDF10\uDF12-\uDF33\uDFB0]|\uD808[\uDC00-\uDF99]|\uD809[\uDC80-\uDD43]|\uD80B[\uDF90-\uDFF0]|[\uD80C\uD80E\uD80F\uD81C-\uD822\uD840-\uD868\uD86A-\uD86D\uD86F-\uD872\uD874-\uD879\uD880-\uD883\uD885-\uD88C][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2F\uDC41-\uDC46\uDC60-\uDFFF]|\uD810[\uDC00-\uDFFA]|\uD811[\uDC00-\uDE46]|\uD818[\uDD00-\uDD1D]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE70-\uDEBE\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDD40-\uDD6C\uDE40-\uDE7F\uDEA0-\uDEB8\uDEBB-\uDED3\uDF00-\uDF4A\uDF50\uDF93-\uDF9F\uDFE0\uDFE1\uDFE3\uDFF2\uDFF3]|\uD823[\uDC00-\uDCD5\uDCFF-\uDD1E\uDD80-\uDDF2]|\uD82B[\uDFF0-\uDFF3\uDFF5-\uDFFB\uDFFD\uDFFE]|\uD82C[\uDC00-\uDD22\uDD32\uDD50-\uDD52\uDD55\uDD64-\uDD67\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB]|\uD837[\uDF00-\uDF1E\uDF25-\uDF2A]|\uD838[\uDC30-\uDC6D\uDD00-\uDD2C\uDD37-\uDD3D\uDD4E\uDE90-\uDEAD\uDEC0-\uDEEB]|\uD839[\uDCD0-\uDCEB\uDDD0-\uDDED\uDDF0\uDEC0-\uDEDE\uDEE0-\uDEE2\uDEE4\uDEE5\uDEE7-\uDEED\uDEF0-\uDEF4\uDEFE\uDEFF\uDFE0-\uDFE6\uDFE8-\uDFEB\uDFED\uDFEE\uDFF0-\uDFFE]|\uD83A[\uDC00-\uDCC4\uDD00-\uDD43\uDD4B]|\uD83B[\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD869[\uDC00-\uDEDF\uDF00-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEAD\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0\uDFF0-\uDFFF]|\uD87B[\uDC00-\uDE5D]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A\uDF50-\uDFFF]|\uD88D[\uDC00-\uDC79])|(?:[0-9\xB2\xB3\xB9\xBC-\xBE\u0660-\u0669\u06F0-\u06F9\u07C0-\u07C9\u0966-\u096F\u09E6-\u09EF\u09F4-\u09F9\u0A66-\u0A6F\u0AE6-\u0AEF\u0B66-\u0B6F\u0B72-\u0B77\u0BE6-\u0BF2\u0C66-\u0C6F\u0C78-\u0C7E\u0CE6-\u0CEF\u0D58-\u0D5E\u0D66-\u0D78\u0DE6-\u0DEF\u0E50-\u0E59\u0ED0-\u0ED9\u0F20-\u0F33\u1040-\u1049\u1090-\u1099\u1369-\u137C\u16EE-\u16F0\u17E0-\u17E9\u17F0-\u17F9\u1810-\u1819\u1946-\u194F\u19D0-\u19DA\u1A80-\u1A89\u1A90-\u1A99\u1B50-\u1B59\u1BB0-\u1BB9\u1C40-\u1C49\u1C50-\u1C59\u2070\u2074-\u2079\u2080-\u2089\u2150-\u2182\u2185-\u2189\u2460-\u249B\u24EA-\u24FF\u2776-\u2793\u2CFD\u3007\u3021-\u3029\u3038-\u303A\u3192-\u3195\u3220-\u3229\u3248-\u324F\u3251-\u325F\u3280-\u3289\u32B1-\u32BF\uA620-\uA629\uA6E6-\uA6EF\uA830-\uA835\uA8D0-\uA8D9\uA900-\uA909\uA9D0-\uA9D9\uA9F0-\uA9F9\uAA50-\uAA59\uABF0-\uABF9\uFF10-\uFF19]|\uD800[\uDD07-\uDD33\uDD40-\uDD78\uDD8A\uDD8B\uDEE1-\uDEFB\uDF20-\uDF23\uDF41\uDF4A\uDFD1-\uDFD5]|\uD801[\uDCA0-\uDCA9]|\uD802[\uDC58-\uDC5F\uDC79-\uDC7F\uDCA7-\uDCAF\uDCFB-\uDCFF\uDD16-\uDD1B\uDDBC\uDDBD\uDDC0-\uDDCF\uDDD2-\uDDFF\uDE40-\uDE48\uDE7D\uDE7E\uDE9D-\uDE9F\uDEEB-\uDEEF\uDF58-\uDF5F\uDF78-\uDF7F\uDFA9-\uDFAF]|\uD803[\uDCFA-\uDCFF\uDD30-\uDD39\uDD40-\uDD49\uDE60-\uDE7E\uDF1D-\uDF26\uDF51-\uDF54\uDFC5-\uDFCB]|\uD804[\uDC52-\uDC6F\uDCF0-\uDCF9\uDD36-\uDD3F\uDDD0-\uDDD9\uDDE1-\uDDF4\uDEF0-\uDEF9]|\uD805[\uDC50-\uDC59\uDCD0-\uDCD9\uDE50-\uDE59\uDEC0-\uDEC9\uDED0-\uDEE3\uDF30-\uDF3B]|\uD806[\uDCE0-\uDCF2\uDD50-\uDD59\uDFF0-\uDFF9]|\uD807[\uDC50-\uDC6C\uDD50-\uDD59\uDDA0-\uDDA9\uDDE0-\uDDE9\uDF50-\uDF59\uDFC0-\uDFD4]|\uD809[\uDC00-\uDC6E]|\uD818[\uDD30-\uDD39]|\uD81A[\uDE60-\uDE69\uDEC0-\uDEC9\uDF50-\uDF59\uDF5B-\uDF61]|\uD81B[\uDD70-\uDD79\uDE80-\uDE96\uDFF4-\uDFF6]|\uD833[\uDCF0-\uDCF9]|\uD834[\uDEC0-\uDED3\uDEE0-\uDEF3\uDF60-\uDF78]|\uD835[\uDFCE-\uDFFF]|\uD838[\uDD40-\uDD49\uDEF0-\uDEF9]|\uD839[\uDCF0-\uDCF9\uDDF1-\uDDFA]|\uD83A[\uDCC7-\uDCCF\uDD50-\uDD59]|\uD83B[\uDC71-\uDCAB\uDCAD-\uDCAF\uDCB1-\uDCB4\uDD01-\uDD2D\uDD2F-\uDD3D]|\uD83C[\uDD00-\uDD0C]|\uD83E[\uDFF0-\uDFF9])/.test(snapshotText[leftIdx]) && /(?:[A-Za-z\xAA\xB5\xBA\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0560-\u0588\u05D0-\u05EA\u05EF-\u05F2\u0620-\u064A\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07CA-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u0870-\u0887\u0889-\u088F\u08A0-\u08C9\u0904-\u0939\u093D\u0950\u0958-\u0961\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09F0\u09F1\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B71\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C5C\u0C5D\u0C60\u0C61\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDC-\u0CDE\u0CE0\u0CE1\u0CF1\u0CF2\u0D04-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D5F-\u0D61\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E81\u0E82\u0E84\u0E86-\u0E8A\u0E8C-\u0EA3\u0EA5\u0EA7-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0EDC-\u0EDF\u0F00\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16F1-\u16F8\u1700-\u1711\u171F-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u1820-\u1878\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1950-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u1A00-\u1A16\u1A20-\u1A54\u1AA7\u1B05-\u1B33\u1B45-\u1B4C\u1B83-\u1BA0\u1BAE\u1BAF\u1BBA-\u1BE5\u1C00-\u1C23\u1C4D-\u1C4F\u1C5A-\u1C7D\u1C80-\u1C8A\u1C90-\u1CBA\u1CBD-\u1CBF\u1CE9-\u1CEC\u1CEE-\u1CF3\u1CF5\u1CF6\u1CFA\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2071\u207F\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2183\u2184\u2C00-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005\u3006\u3031-\u3035\u303B\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312F\u3131-\u318E\u31A0-\u31BF\u31F0-\u31FF\u3400-\u4DBF\u4E00-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA61F\uA62A\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6E5\uA717-\uA71F\uA722-\uA788\uA78B-\uA7DC\uA7F1-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA840-\uA873\uA882-\uA8B3\uA8F2-\uA8F7\uA8FB\uA8FD\uA8FE\uA90A-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF\uA9E0-\uA9E4\uA9E6-\uA9EF\uA9FA-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB69\uAB70-\uABE2\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDE80-\uDE9C\uDEA0-\uDED0\uDF00-\uDF1F\uDF2D-\uDF40\uDF42-\uDF49\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF]|\uD801[\uDC00-\uDC9D\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDD70-\uDD7A\uDD7C-\uDD8A\uDD8C-\uDD92\uDD94\uDD95\uDD97-\uDDA1\uDDA3-\uDDB1\uDDB3-\uDDB9\uDDBB\uDDBC\uDDC0-\uDDF3\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67\uDF80-\uDF85\uDF87-\uDFB0\uDFB2-\uDFBA]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC60-\uDC76\uDC80-\uDC9E\uDCE0-\uDCF2\uDCF4\uDCF5\uDD00-\uDD15\uDD20-\uDD39\uDD40-\uDD59\uDD80-\uDDB7\uDDBE\uDDBF\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE35\uDE60-\uDE7C\uDE80-\uDE9C\uDEC0-\uDEC7\uDEC9-\uDEE4\uDF00-\uDF35\uDF40-\uDF55\uDF60-\uDF72\uDF80-\uDF91]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2\uDD00-\uDD23\uDD4A-\uDD65\uDD6F-\uDD85\uDE80-\uDEA9\uDEB0\uDEB1\uDEC2-\uDEC7\uDF00-\uDF1C\uDF27\uDF30-\uDF45\uDF70-\uDF81\uDFB0-\uDFC4\uDFE0-\uDFF6]|\uD804[\uDC03-\uDC37\uDC71\uDC72\uDC75\uDC83-\uDCAF\uDCD0-\uDCE8\uDD03-\uDD26\uDD44\uDD47\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDDA\uDDDC\uDE00-\uDE11\uDE13-\uDE2B\uDE3F\uDE40\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61\uDF80-\uDF89\uDF8B\uDF8E\uDF90-\uDFB5\uDFB7\uDFD1\uDFD3]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC5F-\uDC61\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE80-\uDEAA\uDEB8\uDF00-\uDF1A\uDF40-\uDF46]|\uD806[\uDC00-\uDC2B\uDCA0-\uDCDF\uDCFF-\uDD06\uDD09\uDD0C-\uDD13\uDD15\uDD16\uDD18-\uDD2F\uDD3F\uDD41\uDDA0-\uDDA7\uDDAA-\uDDD0\uDDE1\uDDE3\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE89\uDE9D\uDEB0-\uDEF8\uDFC0-\uDFE0]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46\uDD60-\uDD65\uDD67\uDD68\uDD6A-\uDD89\uDD98\uDDB0-\uDDDB\uDEE0-\uDEF2\uDF02\uDF04-\uDF10\uDF12-\uDF33\uDFB0]|\uD808[\uDC00-\uDF99]|\uD809[\uDC80-\uDD43]|\uD80B[\uDF90-\uDFF0]|[\uD80C\uD80E\uD80F\uD81C-\uD822\uD840-\uD868\uD86A-\uD86D\uD86F-\uD872\uD874-\uD879\uD880-\uD883\uD885-\uD88C][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2F\uDC41-\uDC46\uDC60-\uDFFF]|\uD810[\uDC00-\uDFFA]|\uD811[\uDC00-\uDE46]|\uD818[\uDD00-\uDD1D]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE70-\uDEBE\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDD40-\uDD6C\uDE40-\uDE7F\uDEA0-\uDEB8\uDEBB-\uDED3\uDF00-\uDF4A\uDF50\uDF93-\uDF9F\uDFE0\uDFE1\uDFE3\uDFF2\uDFF3]|\uD823[\uDC00-\uDCD5\uDCFF-\uDD1E\uDD80-\uDDF2]|\uD82B[\uDFF0-\uDFF3\uDFF5-\uDFFB\uDFFD\uDFFE]|\uD82C[\uDC00-\uDD22\uDD32\uDD50-\uDD52\uDD55\uDD64-\uDD67\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB]|\uD837[\uDF00-\uDF1E\uDF25-\uDF2A]|\uD838[\uDC30-\uDC6D\uDD00-\uDD2C\uDD37-\uDD3D\uDD4E\uDE90-\uDEAD\uDEC0-\uDEEB]|\uD839[\uDCD0-\uDCEB\uDDD0-\uDDED\uDDF0\uDEC0-\uDEDE\uDEE0-\uDEE2\uDEE4\uDEE5\uDEE7-\uDEED\uDEF0-\uDEF4\uDEFE\uDEFF\uDFE0-\uDFE6\uDFE8-\uDFEB\uDFED\uDFEE\uDFF0-\uDFFE]|\uD83A[\uDC00-\uDCC4\uDD00-\uDD43\uDD4B]|\uD83B[\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD869[\uDC00-\uDEDF\uDF00-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEAD\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0\uDFF0-\uDFFF]|\uD87B[\uDC00-\uDE5D]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A\uDF50-\uDFFF]|\uD88D[\uDC00-\uDC79])|(?:[0-9\xB2\xB3\xB9\xBC-\xBE\u0660-\u0669\u06F0-\u06F9\u07C0-\u07C9\u0966-\u096F\u09E6-\u09EF\u09F4-\u09F9\u0A66-\u0A6F\u0AE6-\u0AEF\u0B66-\u0B6F\u0B72-\u0B77\u0BE6-\u0BF2\u0C66-\u0C6F\u0C78-\u0C7E\u0CE6-\u0CEF\u0D58-\u0D5E\u0D66-\u0D78\u0DE6-\u0DEF\u0E50-\u0E59\u0ED0-\u0ED9\u0F20-\u0F33\u1040-\u1049\u1090-\u1099\u1369-\u137C\u16EE-\u16F0\u17E0-\u17E9\u17F0-\u17F9\u1810-\u1819\u1946-\u194F\u19D0-\u19DA\u1A80-\u1A89\u1A90-\u1A99\u1B50-\u1B59\u1BB0-\u1BB9\u1C40-\u1C49\u1C50-\u1C59\u2070\u2074-\u2079\u2080-\u2089\u2150-\u2182\u2185-\u2189\u2460-\u249B\u24EA-\u24FF\u2776-\u2793\u2CFD\u3007\u3021-\u3029\u3038-\u303A\u3192-\u3195\u3220-\u3229\u3248-\u324F\u3251-\u325F\u3280-\u3289\u32B1-\u32BF\uA620-\uA629\uA6E6-\uA6EF\uA830-\uA835\uA8D0-\uA8D9\uA900-\uA909\uA9D0-\uA9D9\uA9F0-\uA9F9\uAA50-\uAA59\uABF0-\uABF9\uFF10-\uFF19]|\uD800[\uDD07-\uDD33\uDD40-\uDD78\uDD8A\uDD8B\uDEE1-\uDEFB\uDF20-\uDF23\uDF41\uDF4A\uDFD1-\uDFD5]|\uD801[\uDCA0-\uDCA9]|\uD802[\uDC58-\uDC5F\uDC79-\uDC7F\uDCA7-\uDCAF\uDCFB-\uDCFF\uDD16-\uDD1B\uDDBC\uDDBD\uDDC0-\uDDCF\uDDD2-\uDDFF\uDE40-\uDE48\uDE7D\uDE7E\uDE9D-\uDE9F\uDEEB-\uDEEF\uDF58-\uDF5F\uDF78-\uDF7F\uDFA9-\uDFAF]|\uD803[\uDCFA-\uDCFF\uDD30-\uDD39\uDD40-\uDD49\uDE60-\uDE7E\uDF1D-\uDF26\uDF51-\uDF54\uDFC5-\uDFCB]|\uD804[\uDC52-\uDC6F\uDCF0-\uDCF9\uDD36-\uDD3F\uDDD0-\uDDD9\uDDE1-\uDDF4\uDEF0-\uDEF9]|\uD805[\uDC50-\uDC59\uDCD0-\uDCD9\uDE50-\uDE59\uDEC0-\uDEC9\uDED0-\uDEE3\uDF30-\uDF3B]|\uD806[\uDCE0-\uDCF2\uDD50-\uDD59\uDFF0-\uDFF9]|\uD807[\uDC50-\uDC6C\uDD50-\uDD59\uDDA0-\uDDA9\uDDE0-\uDDE9\uDF50-\uDF59\uDFC0-\uDFD4]|\uD809[\uDC00-\uDC6E]|\uD818[\uDD30-\uDD39]|\uD81A[\uDE60-\uDE69\uDEC0-\uDEC9\uDF50-\uDF59\uDF5B-\uDF61]|\uD81B[\uDD70-\uDD79\uDE80-\uDE96\uDFF4-\uDFF6]|\uD833[\uDCF0-\uDCF9]|\uD834[\uDEC0-\uDED3\uDEE0-\uDEF3\uDF60-\uDF78]|\uD835[\uDFCE-\uDFFF]|\uD838[\uDD40-\uDD49\uDEF0-\uDEF9]|\uD839[\uDCF0-\uDCF9\uDDF1-\uDDFA]|\uD83A[\uDCC7-\uDCCF\uDD50-\uDD59]|\uD83B[\uDC71-\uDCAB\uDCAD-\uDCAF\uDCB1-\uDCB4\uDD01-\uDD2D\uDD2F-\uDD3D]|\uD83C[\uDD00-\uDD0C]|\uD83E[\uDFF0-\uDFF9])/.test(snapshotText[rightIdx]);
}
function resolveDeleteOperationFromSnapshot(snapshotText, sourceText, suggestion) {
  var _suggestion$meta14, _ref30, _ref31, _meta$sourceTokenAt2, _ref32, _ref33, _ref34, _suggestion$charHint$4, _suggestion$charHint6, _suggestion$meta15;
  var meta = suggestion === null || suggestion === void 0 || (_suggestion$meta14 = suggestion.meta) === null || _suggestion$meta14 === void 0 ? void 0 : _suggestion$meta14.anchor;
  if (!meta) return {
    op: null,
    skipReason: "delete_missing_anchor_meta"
  };
  var sourceAnchor = (_ref30 = (_ref31 = (_meta$sourceTokenAt2 = meta.sourceTokenAt) !== null && _meta$sourceTokenAt2 !== void 0 ? _meta$sourceTokenAt2 : meta.sourceTokenBefore) !== null && _ref31 !== void 0 ? _ref31 : meta.sourceTokenAfter) !== null && _ref30 !== void 0 ? _ref30 : meta.highlightAnchorTarget;
  var charStart = (_ref32 = (_ref33 = (_ref34 = (_suggestion$charHint$4 = suggestion === null || suggestion === void 0 || (_suggestion$charHint6 = suggestion.charHint) === null || _suggestion$charHint6 === void 0 ? void 0 : _suggestion$charHint6.start) !== null && _suggestion$charHint$4 !== void 0 ? _suggestion$charHint$4 : meta.charStart) !== null && _ref34 !== void 0 ? _ref34 : sourceAnchor === null || sourceAnchor === void 0 ? void 0 : sourceAnchor.charStart) !== null && _ref33 !== void 0 ? _ref33 : suggestion === null || suggestion === void 0 || (_suggestion$meta15 = suggestion.meta) === null || _suggestion$meta15 === void 0 || (_suggestion$meta15 = _suggestion$meta15.op) === null || _suggestion$meta15 === void 0 ? void 0 : _suggestion$meta15.originalPos) !== null && _ref32 !== void 0 ? _ref32 : -1;
  if (!Number.isFinite(charStart) || charStart < 0) return {
    op: null,
    skipReason: "delete_missing_char_hint"
  };
  var mappedStart = mapIndexAcrossCanonical(sourceText, snapshotText, charStart);
  var commaIndex = -1;
  var maxDelta = 1;
  for (var delta = 0; delta <= maxDelta; delta++) {
  ...
  if (commaIndex < 0) return {
    op: null,
    skipReason: "delete_comma_not_found_near_hint"
  };
  if (isProtectedAbbreviationComma(snapshotText, commaIndex)) return {
    op: null,
    skipReason: "delete_protected_abbreviation"
  };
  if (!hasStrongDeleteContext(snapshotText, sourceText, suggestion, commaIndex)) {
    var charAligned = Math.abs(commaIndex - mappedStart) <= 1;
    var safeBoundary = hasWordBoundaryAroundComma(snapshotText, commaIndex);
    if (!(charAligned && safeBoundary)) {
      return {
        op: null,
        skipReason: "delete_context_mismatch"
      };
    }
  }
  return {
...
function buildParagraphOperationsPlan(snapshotText, sourceText, suggestions) {
  ...
  try {
    for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
      var _opResult$op, _opResult;
      var suggestion = _step6.value;
      var opResult = {
        op: null,
        skipReason: "planner_unknown"
      };
      if ((suggestion === null || suggestion === void 0 ? void 0 : suggestion.kind) === "delete") {
      ...
      var op = (_opResult$op = (_opResult = opResult) === null || _opResult === void 0 ? void 0 : _opResult.op) !== null && _opResult$op !== void 0 ? _opResult$op : null;
      if (!op) {
        var _opResult2;
        skipped.push({
          suggestion: suggestion,
          reason: ((_opResult2 = opResult) === null || _opResult2 === void 0 ? void 0 : _opResult2.skipReason) || "planner_unresolved"
        });
        continue;
      }
      if (op.kind === "noop") {
...
function summarizeSkippedReasons() {
  var skipped = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var summary = {};
  var _iterator7 = _createForOfIteratorHelper(skipped),
    _step7;
  try {
    for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
      var item = _step7.value;
      var reason = (item === null || item === void 0 ? void 0 : item.reason) || "planner_unresolved";
...
function buildSkippedSuggestionLogEntry(skippedItem) {
  var _suggestion$meta16, _ref35, _ref36, _ref37, _ref38, _suggestion$charHint$5, _suggestion$charHint7, _meta$sourceTokenAt3, _meta$sourceTokenBefo3, _meta$sourceTokenAfte3, _suggestion$id, _suggestion$kind;
  var sourceText = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  var suggestion = (skippedItem === null || skippedItem === void 0 ? void 0 : skippedItem.suggestion) || {};
  var meta = (suggestion === null || suggestion === void 0 || (_suggestion$meta16 = suggestion.meta) === null || _suggestion$meta16 === void 0 ? void 0 : _suggestion$meta16.anchor) || {};
  var hintStart = (_ref35 = (_ref36 = (_ref37 = (_ref38 = (_suggestion$charHint$5 = suggestion === null || suggestion === void 0 || (_suggestion$charHint7 = suggestion.charHint) === null || _suggestion$charHint7 === void 0 ? void 0 : _suggestion$charHint7.start) !== null && _suggestion$charHint$5 !== void 0 ? _suggestion$charHint$5 : meta === null || meta === void 0 ? void 0 : meta.charStart) !== null && _ref38 !== void 0 ? _ref38 : meta === null || meta === void 0 || (_meta$sourceTokenAt3 = meta.sourceTokenAt) === null || _meta$sourceTokenAt3 === void 0 ? void 0 : _meta$sourceTokenAt3.charStart) !== null && _ref37 !== void 0 ? _ref37 : meta === null || meta === void 0 || (_meta$sourceTokenBefo3 = meta.sourceTokenBefore) === null || _meta$sourceTokenBefo3 === void 0 ? void 0 : _meta$sourceTokenBefo3.charStart) !== null && _ref36 !== void 0 ? _ref36 : meta === null || meta === void 0 || (_meta$sourceTokenAfte3 = meta.sourceTokenAfter) === null || _meta$sourceTokenAfte3 === void 0 ? void 0 : _meta$sourceTokenAfte3.charStart) !== null && _ref35 !== void 0 ? _ref35 : -1;
  var start = Number.isFinite(hintStart) ? Math.max(0, hintStart) : -1;
  var from = start >= 0 ? Math.max(0, start - 24) : 0;
  var to = start >= 0 ? Math.min(sourceText.length, start + 40) : Math.min(sourceText.length, 64);
  return {
    reason: (skippedItem === null || skippedItem === void 0 ? void 0 : skippedItem.reason) || "planner_unresolved",
    id: (_suggestion$id = suggestion === null || suggestion === void 0 ? void 0 : suggestion.id) !== null && _suggestion$id !== void 0 ? _suggestion$id : null,
    kind: (_suggestion$kind = suggestion === null || suggestion === void 0 ? void 0 : suggestion.kind) !== null && _suggestion$kind !== void 0 ? _suggestion$kind : null,
    hintStart: start,
...
function _applyAllSuggestionsOnline() {
  _applyAllSuggestionsOnline = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee39() {
    var startedAt, summary, finalize, scanCompleted, actionToken, restored, autoApplySuggestions, retainedSuggestions, _iterator18, _step18, _sug, retainedByLevel, retainedDetails, suggestionsByParagraph, _i5, _autoApplySuggestions, sug;
    return _regenerator().w(function (_context40) {
      while (1) switch (_context40.p = _context40.n) {
        case 0:
          ...
          finalize = function finalize(status) {
          ...
          _context40.n = 1;
          return waitForOnlineScanCompletion();
        case 1:
          scanCompleted = _context40.v;
          if (scanCompleted) {
            _context40.n = 2;
            break;
          }
          ...
          return _context40.a(2, finalize("deferred", "scan-in-progress"));
        case 2:
          actionToken = beginAction(ACTION_TYPE_APPLY);
          if (actionToken) {
            _context40.n = 3;
            break;
          }
          return _context40.a(2, finalize("deferred", "action-in-progress"));
        case 3:
          _context40.p = 3;
          if (!pendingSuggestionsOnline.length) {
          ...
          return _context40.a(2, finalize("noop", "no-pending-suggestions"));
        case 4:
          autoApplySuggestions = [];
          retainedSuggestions = [];
          _iterator18 = _createForOfIteratorHelper(pendingSuggestionsOnline);
          try {
            for (_iterator18.s(); !(_step18 = _iterator18.n()).done;) {
              _sug = _step18.value;
              if (isSuggestionAutoApplyEligibleOnline(_sug)) {
                autoApplySuggestions.push(_sug);
              } else {
                retainedSuggestions.push(_sug);
              }
            }
          } catch (err) {
            _iterator18.e(err);
          ...
          if (retainedSuggestions.length) {
            retainedByLevel = retainedSuggestions.reduce(function (acc, sug) {
              var level = getSuggestionConfidenceLevel(sug);
            ...
            retainedDetails = retainedSuggestions.slice(0, 50).map(function (sug) {
              return toConfidenceLogEntry(sug);
            });
          ...
          return _context40.a(2, finalize("noop", "no-eligible-suggestions"));
        case 5:
          suggestionsByParagraph = new Map();
          _i5 = 0, _autoApplySuggestions = autoApplySuggestions;
        case 6:
          if (!(_i5 < _autoApplySuggestions.length)) {
            _context40.n = 9;
            break;
          }
          sug = _autoApplySuggestions[_i5];
          if (!(typeof (sug === null || sug === void 0 ? void 0 : sug.paragraphIndex) !== "number" || sug.paragraphIndex < 0)) {
            _context40.n = 7;
            break;
          }
          return _context40.a(3, 8);
        case 7:
        ...
        case 9:
          ...
          return _context40.a(2, finalize("noop", "no-valid-paragraphs"));
        case 10:
          _context40.n = 11;
          return Word.run(/*#__PURE__*/function () {
            var _ref65 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee38(context) {
              var paras, touchedIndexes, failedSuggestions, _iterator19, _step19, _loop, _iterator20, _step20, idx, _t27;
              return _regenerator().w(function (_context39) {
                while (1) switch (_context39.p = _context39.n) {
                  ...
                  case 1:
                    ...
                    failedSuggestions = [];
                    _iterator19 = _createForOfIteratorHelper(suggestionsByParagraph.entries());
                    _context39.p = 2;
                    _loop = /*#__PURE__*/_regenerator().m(function _loop() {
                      var _entry$originalText7;
                      var _step19$value, paragraphIndex, suggestions, paragraph, markerCleanupSummary, directlyClearedMarkers, entry, snapshotText, sourceText, _buildParagraphOperat, plan, skipped, noop, skippedDetails, anyApplied, appliedCount, applyFailedCount, plannedRanges, opIndex, op, opSuggestionCount, range, insertLocation;
                      return _regenerator().w(function (_context38) {
                        while (1) switch (_context38.n) {
                          case 0:
                            _step19$value = _slicedToArray(_step19.value, 2), paragraphIndex = _step19$value[0], suggestions = _step19$value[1];
                          ...
                          case 1:
                            _context38.n = 2;
                            return clearOnlineSuggestionMarkers(context, suggestions.map(function (suggestion) {
                              return {
                                suggestion: suggestion,
                                paragraph: paragraph
                              };
                          ...
                          case 2:
                            markerCleanupSummary = _context38.v;
                            directlyClearedMarkers = ((markerCleanupSummary === null || markerCleanupSummary === void 0 ? void 0 : markerCleanupSummary.clearedByTagCount) || 0) + ((markerCleanupSummary === null || markerCleanupSummary === void 0 ? void 0 : markerCleanupSummary.clearedFallbackCount) || 0);
                            summary.clearedMarkers += directlyClearedMarkers;
                            summary.failedSuggestions += (markerCleanupSummary === null || markerCleanupSummary === void 0 ? void 0 : markerCleanupSummary.failedCount) || 0;
                            ...
                            if (skipped.length) {
                              ...
                              skippedDetails = skipped.slice(0, 10).map(function (item) {
                                return buildSkippedSuggestionLogEntry(item, sourceText);
                              });
                              log("applyAll skipped details", skippedDetails);
                          ...
                          case 4:
                            ...
                            op = plan[opIndex];
                            opSuggestionCount = Array.isArray(op === null || op === void 0 ? void 0 : op.suggestions) ? op.suggestions.length : 1;
                  ...
                  case 10:
                    ...
                    _iterator20 = _createForOfIteratorHelper(touchedIndexes);
                    try {
                    ...
                    pendingSuggestionsOnline.length = 0;
                    if (retainedSuggestions.length) {
                      pendingSuggestionsOnline.push.apply(pendingSuggestionsOnline, retainedSuggestions);
                    }
        ...
        case 11:
          ...
          return _context40.a(2, finalize("applied"));
        case 12:
          if (!(summary.appliedSuggestions > 0 || summary.failedSuggestions > 0)) {
            _context40.n = 13;
            break;
          }
          return _context40.a(2, finalize("partial", summary.failedSuggestions > 0 ? "some-operations-failed" : null));
        case 13:
          return _context40.a(2, finalize("noop", "no-effective-operations"));
        case 14:
          _context40.p = 14;
          finishAction(actionToken);
          return _context40.f(14);
        case 15:
          return _context40.a(2);
      }
    }, _callee39, null, [[3,, 14, 15]]);
  }));
  return _applyAllSuggestionsOnline.apply(this, arguments);
}
...
function _rejectAllSuggestionsOnline() {
  _rejectAllSuggestionsOnline = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee41() {
    var startedAt, summary, finalize, scanCompleted, actionToken, restored;
    return _regenerator().w(function (_context42) {
      while (1) switch (_context42.p = _context42.n) {
        ...
        case 1:
          ...
          queueScanNotification("Počakajte, da se pregled dokumenta zaključi, nato poskusite znova.");
          flushScanNotifications();
          return _context42.a(2, finalize("deferred", "scan-in-progress"));
        case 2:
          actionToken = beginAction(ACTION_TYPE_REJECT);
          if (actionToken) {
            _context42.n = 3;
            break;
          }
          return _context42.a(2, finalize("deferred", "action-in-progress"));
        case 3:
          _context42.p = 3;
          if (!pendingSuggestionsOnline.length) {
            restored = restorePendingSuggestionsOnline();
            summary.restored = restored;
            if (restored > 0) {
              log("rejectAllSuggestionsOnline: restored ".concat(restored, " pending suggestions from storage"));
            }
          }
          summary.pendingBefore = pendingSuggestionsOnline.length;
          if (pendingSuggestionsOnline.length) {
          ...
          return _context42.a(2, finalize("noop", "no-pending-suggestions"));
        case 4:
          _context42.n = 5;
          return Word.run(/*#__PURE__*/function () {
            var _ref66 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee40(context) {
              var clearResult;
              return _regenerator().w(function (_context41) {
                while (1) switch (_context41.n) {
                  case 0:
                    _context41.n = 1;
                    return wordOnlineAdapter.clearHighlights(context, null, null);
                  case 1:
                    clearResult = _context41.v;
                    summary.clearedMarkers = ((clearResult === null || clearResult === void 0 ? void 0 : clearResult.clearedByTagCount) || 0) + ((clearResult === null || clearResult === void 0 ? void 0 : clearResult.clearedFallbackCount) || 0);
                    summary.failedClear = (clearResult === null || clearResult === void 0 ? void 0 : clearResult.failedCount) || 0;
                    _context41.n = 2;
                    return context.sync();
                  case 2:
        ...
        case 5:
          ...
          return _context42.a(2, finalize(summary.clearedMarkers > 0 ? "partial" : "noop", "some-marker-clear-failures"));
        case 6:
          return _context42.a(2, finalize(summary.clearedMarkers > 0 ? "cleared" : "noop"));
        case 7:
          _context42.p = 7;
          finishAction(actionToken);
          return _context42.f(7);
        case 8:
          return _context42.a(2);
      }
    }, _callee41, null, [[3,, 7, 8]]);
  }));
  return _rejectAllSuggestionsOnline.apply(this, arguments);
}
...
function _checkDocumentText() {
  _checkDocumentText = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee42() {
    var actionToken;
    return _regenerator().w(function (_context43) {
      while (1) switch (_context43.p = _context43.n) {
        case 0:
          actionToken = beginAction(ACTION_TYPE_CHECK);
          if (actionToken) {
            _context43.n = 1;
            break;
          }
        ...
        case 1:
          ...
          _context43.n = 3;
          return checkDocumentTextOnline(actionToken);
        case 3:
        ...
        case 6:
          ...
          finishAction(actionToken);
          return _context43.f(6);
        case 7:
          return _context43.a(2);
      }
    }, _callee42, null, [[2,, 6, 7]]);
  }));
  return _checkDocumentText.apply(this, arguments);
}
...
function _checkDocumentTextDesktop() {
  _checkDocumentTextDesktop = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee44() {
    var totalInserted, totalDeleted, paragraphsProcessed, apiErrors, nonCommaSkips, _t30;
    return _regenerator().w(function (_context45) {
      while (1) switch (_context45.p = _context45.n) {
        case 0:
          ...
          _context45.n = 2;
          return Word.run(/*#__PURE__*/function () {
            var _ref67 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee43(context) {
              var doc, paras, documentCharOffset, idx, _anchorsEntry$origina, paragraph, sourceText, normalizedSource, trimmed, paragraphDocOffset, pStart, _result, suggestions, anchorsEntry, snapshotText, sourceForPlan, _buildParagraphOperat2, plan, skipped, noop, appliedInParagraph, plannedRanges, opIndex, op, range, _op$suggestions, insertLocation, _iterator21, _step21, suggestion, _t28, _t29;
              return _regenerator().w(function (_context44) {
                while (1) switch (_context44.p = _context44.n) {
                  ...
                  case 6:
                    _context44.p = 6;
                    _t28 = _context44.v;
                    warn("trackRevisions not available -> require manual enablement", _t28);
                    notifyTrackChangesRequired();
                    return _context44.a(2);
                  case 7:
                  ...
                  case 15:
                    ...
                    _t29 = _context44.v;
                    apiErrors++;
                    warn("P".concat(idx, ": engine failed"), _t29);
                    notifyApiUnavailable();
                    return _context44.a(3, 26);
                  case 16:
                    apiErrors += _result.apiErrors;
                    nonCommaSkips += _result.nonCommaSkips || 0;
        ...
        case 3:
          _context45.p = 3;
          _t30 = _context45.v;
          errL("ERROR in checkDocumentText:", _t30);
        case 4:
          _context45.p = 4;
          flushScanNotifications();
    ...
    }, _callee44, null, [[1, 3, 4, 5]]);
  }));
  return _checkDocumentTextDesktop.apply(this, arguments);
}
function checkDocumentTextOnline(_x99) {
  return _checkDocumentTextOnline.apply(this, arguments);
}
function _checkDocumentTextOnline() {
  _checkDocumentTextOnline = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee46(checkToken) {
    var paragraphsProcessed, suggestionsDetected, suggestions, apiErrors, nonCommaSkips, _t34;
    return _regenerator().w(function (_context48) {
      while (1) switch (_context48.p = _context48.n) {
        case 0:
          ...
          _context48.n = 2;
          return Word.run(/*#__PURE__*/function () {
            var _ref68 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee45(context) {
              var paras, documentCharOffset, pendingHighlightParagraphs, pendingHighlightSuggestions, paragraphTimeoutMs, _loop2, _ret, idx;
              return _regenerator().w(function (_context47) {
                while (1) switch (_context47.n) {
                  ...
                  case 4:
                    ...
                    paragraphTimeoutMs = resolveOnlineParagraphTimeoutMs();
                    _loop2 = /*#__PURE__*/_regenerator().m(function _loop2(idx) {
                      var p, original, normalizedOriginal, trimmed, paragraphDocOffset, _result2$suggestions, _result2$suggestions2, remainingCheckMs, paragraphGuardTimeoutMs, timeoutReason, _result2, highlightedInParagraph, _iterator22, _step22, suggestionObj, highlighted, shouldFlushNow, _t31, _t32, _t33;
                      return _regenerator().w(function (_context46) {
                        while (1) switch (_context46.p = _context46.n) {
                          ...
                          case 3:
                            _context46.p = 3;
                            _t31 = _context46.v;
                            warn("P".concat(idx, " ONLINE: empty-paragraph anchor init failed"), _t31);
                          case 4:
                            return _context46.a(2, 0);
                          case 5:
                            if (!(trimmed.length > MAX_PARAGRAPH_CHARS)) {
                              _context46.n = 6;
                              break;
                          ...
                          case 6:
                            ...
                            paragraphsProcessed++;
                            _context46.p = 7;
                            remainingCheckMs = (checkToken === null || checkToken === void 0 ? void 0 : checkToken.deadlineAt) > 0 ? Math.max(1, checkToken.deadlineAt - Date.now()) : paragraphTimeoutMs;
                            paragraphGuardTimeoutMs = Math.min(paragraphTimeoutMs, remainingCheckMs);
                            timeoutReason = paragraphGuardTimeoutMs < paragraphTimeoutMs ? CHECK_ABORT_REASON_TIMEOUT : CHECK_ABORT_REASON_PARAGRAPH_TIMEOUT;
                            _context46.n = 8;
                            ...
                            }, paragraphGuardTimeoutMs, timeoutReason, "Paragraph ".concat(idx + 1, " timed out"));
                          case 8:
                            _result2 = _context46.v;
                            ensureCheckActionActive(checkToken);
                            apiErrors += _result2.apiErrors;
                            nonCommaSkips += _result2.nonCommaSkips || 0;
                            suggestionsDetected += ((_result2$suggestions = _result2.suggestions) === null || _result2$suggestions === void 0 ? void 0 : _result2$suggestions.length) || 0;
                            if ((_result2$suggestions2 = _result2.suggestions) !== null && _result2$suggestions2 !== void 0 && _result2$suggestions2.length) {
                              _context46.n = 9;
                              break;
                            }
                            return _context46.a(2, 0);
                          case 9:
                            highlightedInParagraph = 0;
                            _iterator22 = _createForOfIteratorHelper(_result2.suggestions);
                            _context46.p = 10;
                            _iterator22.s();
                          case 11:
                          ...
                          case 17:
                            ...
                            shouldFlushNow = pendingHighlightParagraphs >= ONLINE_HIGHLIGHT_FLUSH_PARAGRAPHS || pendingHighlightSuggestions >= ONLINE_HIGHLIGHT_FLUSH_SUGGESTIONS;
                            if (!shouldFlushNow) {
                              _context46.n = 19;
                              break;
                            }
                          ...
                          case 20:
                            _context46.p = 20;
                            _t33 = _context46.v;
                            if (!(_t33 instanceof CheckAbortError && _t33.reason === CHECK_ABORT_REASON_TIMEOUT)) {
                              _context46.n = 21;
                              break;
                            }
                            throw _t33;
                          case 21:
                            if (!(_t33 instanceof CheckAbortError && _t33.reason === CHECK_ABORT_REASON_PARAGRAPH_TIMEOUT)) {
                              _context46.n = 22;
                              break;
                            }
                            apiErrors++;
                          ...
                          case 22:
                            apiErrors++;
                            warn("P".concat(idx, " ONLINE: paragraph processing failed"), _t33);
                            notifyApiUnavailable();
                          case 23:
                            return _context46.a(2);
                        }
                      }, _loop2, null, [[10, 15, 16, 17], [7, 20], [1, 3]]);
                    });
                    idx = 0;
                  case 5:
                    if (!(idx < paras.items.length)) {
                    ...
                    return _context47.d(_regeneratorValues(_loop2(idx)), 6);
                  case 6:
                    _ret = _context47.v;
                    if (!(_ret === 0)) {
                      _context47.n = 7;
        ...
        case 2:
          log("DONE checkDocumentTextOnline() | paragraphs:", paragraphsProcessed, "| suggestions:", suggestions, "| detected:", suggestionsDetected, "| apiErrors:", apiErrors, "| nonCommaSkips:", nonCommaSkips);
          if (paragraphsProcessed > 0 && suggestionsDetected > 0 && suggestions === 0 && apiErrors === 0 && nonCommaSkips === 0) {
        ...
        case 3:
          _context48.p = 3;
          _t34 = _context48.v;
          if (_t34 instanceof CheckAbortError && _t34.reason === CHECK_ABORT_REASON_TIMEOUT) {
            warn("checkDocumentTextOnline stopped due to timeout");
            queueScanNotification(CHECK_TIMEOUT_MESSAGE);
          } else if (_t34 instanceof CheckAbortError) {
            warn("checkDocumentTextOnline cancelled", _t34.reason);
            queueScanNotification(CHECK_CANCELLED_MESSAGE);
          } else {
            errL("ERROR in checkDocumentTextOnline:", _t34);
          }
        case 4:
          _context48.p = 4;
          flushScanNotifications();
          return _context48.f(4);
        case 5:
          return _context48.a(2);
      }
    }, _callee46, null, [[1, 3, 4, 5]]);
  }));
  return _checkDocumentTextOnline.apply(this, arguments);
}
...
var log = function log() {
  ...
  return (_console = console).log.apply(_console, ["[Vejice Taskpane]"].concat(args));
};
var errL = function errL() {
  var _console2;
  for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
  ...
  return (_console2 = console).error.apply(_console2, ["[Vejice Taskpane]"].concat(args));
};
var busy = false;
var online = false;
...
var refreshPendingStatus = function refreshPendingStatus() {
  ...
  setStatus("Pripravljeno. Predlogi: ".concat(pending.length, "."));
};
...
var runAccept = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
    var _summary$appliedSugge, _summary$pendingAfter, summary, applied, pending, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          if (online) {
...
var runReject = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
    var _summary$clearedMarke, _summary$pendingAfter2, summary, rejected, pending, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          if (online) {
        ...
        case 4:
          summary = _context3.v;
          rejected = Number((_summary$clearedMarke = summary === null || summary === void 0 ? void 0 : summary.clearedMarkers) !== null && _summary$clearedMarke !== void 0 ? _summary$clearedMarke : 0);
