...
function _requestPopravek() {
  _requestPopravek = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(poved) {
    var url, primaryRequestSentence, data, config, attempts, protectedRetryUsed, ogCompatRetryUsed, normalizedRetryUsed, attempt, _performance$now, _performance, _performance$now2, t0, _primaryRequestSenten, _performance$now3, _performance2, _performance2$now, r, t1, _normalizeResponsePay, correctedText, raw, _performance$now4, _performance3, _performance3$now, _t, durationMs, info, canTryProtectedDots, protectedSentence, _poved$length, protectedData, protectedResponse, _normalizeResponsePay2, _correctedText, _raw, protectedInfo, canTryOgCompat, compatPayloads, _iterator5, _step5, compat, _poved$length2, compatResponse, _normalizeResponsePay3, _correctedText2, _raw2, compatInfo, canTryNormalizedTransport, normalized, _poved$length3, normalizedSentence, normalizedData, normalizedResponse, normalizedResult, restored, _raw3, normalizedInfo, retryable, delay, _t2, _t3, _t4, _t5, _t6;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 3:
          url = API_URL;
          primaryRequestSentence = protectDateDots(poved);
        ...
        case 16:
          ...
          _normalizeResponsePay3 = normalizeResponsePayload(poved, compatResponse === null || compatResponse === void 0 ? void 0 : compatResponse.data), _correctedText2 = _normalizeResponsePay3.correctedText, _raw2 = _normalizeResponsePay3.raw;
          _raw2.og_compat = {
            used: true,
            mode: compat.mode
          };
        ...
        case 24:
          ...
          normalizedResult = normalizeResponsePayload(normalized.text, normalizedResponse === null || normalizedResponse === void 0 ? void 0 : normalizedResponse.data);
          restored = restoreOriginalTypography(poved, normalized.text, normalizedResult.correctedText);
          _raw3 = _objectSpread(_objectSpread({}, normalizedResult.raw), {}, {
            source_text: poved,
  ...
  return _createClass(CommaSuggestionEngine, [{
    ...
    value: function () {
      var _analyzeParagraph = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(_ref2) {
        var _this = this;
        var paragraphIndex, originalText, normalizedOriginalText, paragraphDocOffset, _ref2$forceSentenceCh, forceSentenceChunks, _ref2$conservativeSen, conservativeSentenceFallback, paragraphText, forceSentenceByLength, useSentenceChunks, debugEnabled, debugDump, chunks, normalizedSource, processedMeta, chunkDetails, apiErrors, nonCommaChunkSkips, _processChunk, _iterator2, _step2, chunk, hasDetailedChunk, canFallbackToSentences, _anchorsEntry, correctedParagraph, sourceTokens, targetTokens, anchorsEntry, suggestions, debugOpFlow, _i, _chunkDetails, _entry$metaRef, _entry$metaRef$remapp, entry, detailRef, ops, correctionTracking, correctionsPresent, fallbackOps, usingFallbackOnly, allOps, opFlow, _iterator3, _step3, op, offset, baseOp, adjustedOp, suggestion, _t3, _t4, _t5, _t6;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
...
function buildSnippetsFromMetadata(metadata, originalText, correctedText) {
  ...
  if (originalText) {
    ...
    var _ref5, _metadata$targetCharS, _ref6, _metadata$targetCharE;
    var start = (_ref5 = (_metadata$targetCharS = metadata.targetCharStart) !== null && _metadata$targetCharS !== void 0 ? _metadata$targetCharS : metadata.charStart) !== null && _ref5 !== void 0 ? _ref5 : 0;
    var end = (_ref6 = (_metadata$targetCharE = metadata.targetCharEnd) !== null && _metadata$targetCharE !== void 0 ? _metadata$targetCharE : metadata.charEnd) !== null && _ref6 !== void 0 ? _ref6 : start;
...
function splitParagraphIntoChunks() {
  ...
  var _ref7 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
    _ref7$preferWholePara = _ref7.preferWholeParagraph,
    preferWholeParagraph = _ref7$preferWholePara === void 0 ? true : _ref7$preferWholePara,
    _ref7$conservativePac = _ref7.conservativePack,
    conservativePack = _ref7$conservativePac === void 0 ? false : _ref7$conservativePac;
  var safeText = typeof text === "string" ? text : "";
  if (!safeText) return [];
  ...
  var pushSentence = function pushSentence(contentEnd) {
    ...
    if (typeof contentEnd !== "number" || contentEnd <= start) {
      var _ref8;
      start = Math.max(start, (_ref8 = gapEnd !== null && gapEnd !== void 0 ? gapEnd : contentEnd) !== null && _ref8 !== void 0 ? _ref8 : start);
      return;
    }
    sentences.push({
      start: start,
...
function buildChunksFromLemmaTokens() {
  ...
  var pushSentence = function pushSentence(contentEnd) {
    ...
    if (typeof contentEnd !== "number" || contentEnd <= sentenceStart) {
      var _ref9;
      sentenceStart = Math.max(sentenceStart, (_ref9 = gapEnd !== null && gapEnd !== void 0 ? gapEnd : contentEnd) !== null && _ref9 !== void 0 ? _ref9 : sentenceStart);
      return;
    }
    sentences.push({
      start: sentenceStart,
  ...
  if (tracking && (_tracking$intents = tracking.intents) !== null && _tracking$intents !== void 0 && _tracking$intents.length) {
    ...
    try {
      for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
        var _ref0, _ref1, _intent$baseText, _intent$analysis, _intent$analysis2, _intent$analysis3;
        var intent = _step6.value;
        var anchor = intent === null || intent === void 0 ? void 0 : intent.anchor;
        if (!anchor) continue;
        var baseText = (_ref0 = (_ref1 = (_intent$baseText = intent.baseText) !== null && _intent$baseText !== void 0 ? _intent$baseText : (_intent$analysis = intent.analysis) === null || _intent$analysis === void 0 ? void 0 : _intent$analysis.baseText) !== null && _ref1 !== void 0 ? _ref1 : anchor.tokenText) !== null && _ref0 !== void 0 ? _ref0 : "";
...
function buildInsertSuggestionMetadata(entry, _ref10) {
  var _entry$documentOffset2, _ref11, _ref12, _ref13, _ref14, _sourceAround$at, _highlightAnchor$char, _entry$originalText2, _entry$paragraphIndex2;
  var originalCharIndex = _ref10.originalCharIndex,
    targetCharIndex = _ref10.targetCharIndex;
  if (!entry) return null;
  ...
  var highlightAnchor = (_ref11 = (_ref12 = (_ref13 = (_ref14 = (_sourceAround$at = sourceAround.at) !== null && _sourceAround$at !== void 0 ? _sourceAround$at : sourceAround.before) !== null && _ref14 !== void 0 ? _ref14 : sourceAround.after) !== null && _ref13 !== void 0 ? _ref13 : targetAround.at) !== null && _ref12 !== void 0 ? _ref12 : targetAround.before) !== null && _ref11 !== void 0 ? _ref11 : targetAround.after;
